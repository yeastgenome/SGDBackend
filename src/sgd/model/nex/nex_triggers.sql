DROP TRIGGER PRIMARY_TRIGGER;
--/
CREATE TRIGGER PRIMARY_TRIGGER
BEFORE INSERT ON primaryobject
FOR EACH ROW
BEGIN
SELECT CURATION_OBJECT_SEQ.nextval INTO :new.id FROM DUAL;
END;
/

DROP TRIGGER SECONDARY_TRIGGER;
--/
CREATE TRIGGER SECONDARY_TRIGGER
BEFORE INSERT ON secondaryobject
FOR EACH ROW
BEGIN
SELECT CURATION_OBJECT_SEQ.nextval INTO :new.id FROM DUAL;
END;
