...
--/
CREATE OR REPLACE TRIGGER DBUSER_TRIGGER
...
FOR EACH ROW
BEGIN
SELECT delete_log_seq.nextval INTO :new.delete_log_id FROM DUAL;
END;
/
...
--/
CREATE OR REPLACE TRIGGER TAXONOMY_TRIGGER
...
FOR EACH ROW
BEGIN
SELECT update_log_seq.nextval INTO :new.update_log_id FROM DUAL;
END;
/