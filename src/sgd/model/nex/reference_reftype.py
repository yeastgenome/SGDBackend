...
class ReferenceReftype(Base, EqualityByIDMixin, ToJsonMixin, UpdateWithJsonMixin):
    ...
    __eq_values__ = ['id', 'display_name', 'link', 'reference_id', 'bud_id', 
    ...
    def unique_key(self):
        return self.reference_id, self.display_name, self.link
