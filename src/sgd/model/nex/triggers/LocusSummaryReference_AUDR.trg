CREATE OR REPLACE TRIGGER LocusSummaryReference_AUDR
--
--  After a row in the locus_summary_reference table is updated or deleted, 
--  write record to update_log or delete_log table
--
    AFTER UPDATE OR DELETE ON locus_summary_reference
    FOR EACH ROW
DECLARE
...
END LocusSummaryReference_AUDR;
/
SHOW ERROR
