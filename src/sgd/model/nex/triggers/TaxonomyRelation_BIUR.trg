Create OR REPLACE TRIGGER TaxonomyRelation_BIUR
--
-- Before insert or update trigger for taxonomy_relation table
--
  BEFORE INSERT OR UPDATE ON taxonomy_relation
  FOR EACH ROW
DECLARE
