CREATE OR REPLACE TRIGGER PathwaySummaryReference_AUDR
--
--  After a row in the pathway_summary_reference table is updated or deleted, 
--  write record to update_log or delete_log table
--
    AFTER UPDATE OR DELETE ON pathway_summary_reference
    FOR EACH ROW
DECLARE
...
END PathwaySummaryReference_AUDR;
/
SHOW ERROR
