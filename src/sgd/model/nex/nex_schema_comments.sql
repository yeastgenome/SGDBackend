...
Comment on column COLLEAGUE.FORMAT_NAME is 'Unique name to create download files ([first_name]_[middle_name]_[last_name]_[sequentialnumber].';
Comment on column COLLEAGUE.DISPLAY_NAME is 'Public display name ([first_name] [middle_name] [last_name]).';
...
Comment on column COLLEAGUE.MIDDLE_NAME is 'Middle name or initial of the colleague.';
Comment on column COLLEAGUE.FIRST_NAME is 'First name of the colleague.';
...
Comment on column COLLEAGUE.IS_BETA_TESTER is 'Whether the colleague is a beta tester for SGD (default 0).';
...
Comment on column PROTEINEXPTANNOTATION_COND.CONDITION_CLASS is 'Class of the condition (Temperature, Chemical, Media, Phase, etc.).';
