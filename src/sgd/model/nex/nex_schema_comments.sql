...
Comment on column GOTERM.GOTERM_ID is 'Unique random identifier (Oracle sequence).';
...
Comment on column GOTERM_ALIAS.ALIAS_ID is 'Unique random identifier (Oracle sequence).';
...
Comment on column GOTERM_URL.URL_ID is 'Unique random identifier (Oracle sequence).';
...
Comment on column GOTERM_RELATION.RELATION_ID is 'Unique random identifier (Oracle sequence).';
