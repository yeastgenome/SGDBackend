...
Comment on column ARCH_DNASEQANNOTATION.ANNOTATION_ID is 'Unique identifier (Oracle sequence).';
Comment on column ARCH_DNASEQANNOTATION.DBENTITY_ID is 'FK to DBENTITY.DBENTITY_ID.';
Comment on column ARCH_DNASEQANNOTATION.SOURCE_ID is 'FK to SOURCE.SOURCE_ID.';
Comment on column ARCH_DNASEQANNOTATION.TAXONOMY_ID is 'FK to TAXONOMY.TAXONOMY_ID.';
Comment on column ARCH_DNASEQANNOTATION.REFERENCE_ID is 'FK to REFERENCEBENTITY.DBENTITY_ID.';
Comment on column ARCH_DNASEQANNOTATION.BUD_ID is 'From BUD.SEQ.SEQ_NO.';
Comment on column ARCH_DNASEQANNOTATION.SO_ID is 'FK to SO.SO_ID.';
Comment on column ARCH_DNASEQANNOTATION.DNA_TYPE is 'Type of DNA sequence (CODING, 1KB, GENOMIC).';
Comment on column ARCH_DNASEQANNOTATION.CONTIG_ID is 'FK to CONTIG.CONTIG_ID.';
...
Comment on column ARCH_DNASEQANNOTATION.GENOMERELEASE_ID is 'FK to GENOMERELEASE.GENOMERELEASE_ID.';
...
Comment on column ARCH_DNASEQANNOTATION.FILE_ID is 'FK to FILE.FILE_ID.';
...
Comment on column ARCH_PROTEINSEQANNOTATION.ANNOTATION_ID is 'Unique identifier (Oracle sequence).';
Comment on column ARCH_PROTEINSEQANNOTATION.DBENTITY_ID is 'FK to DBENTITY.DBENTITY_ID.';
Comment on column ARCH_PROTEINSEQANNOTATION.SOURCE_ID is 'FK to SOURCE.SOURCE_ID.';
Comment on column ARCH_PROTEINSEQANNOTATION.REFERENCE_ID is 'FK to REFERENCEBENTITY.DBENTITY_ID.';
Comment on column ARCH_PROTEINSEQANNOTATION.TAXONOMY_ID is 'FK to TAXONOMY.TAXONOMY_ID.';
Comment on column ARCH_PROTEINSEQANNOTATION.BUD_ID is 'From BUD.PROTEIN.INFO.';
Comment on column ARCH_PROTEINSEQANNOTATION.CONTIG_ID is 'FK to CONTIG.CONTIG_ID.';
Comment on column ARCH_PROTEINSEQANNOTATION.SEQ_VERSION is 'Date of the protein sequence release.';
Comment on column ARCH_PROTEINSEQANNOTATION.GENOMERELEASE_ID is 'FK to GENOMERELEASE.GENOMERELEASE_ID.';
...
Comment on column ARCH_PROTEINSEQANNOTATION.FILE_ID is 'FK to FILE.FILE_ID.';
