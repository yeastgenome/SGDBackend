...
class Apo(Base, EqualityByIDMixin, ToJsonMixin, UpdateWithJsonMixin):
    ...
    namespace_group = Column('namespace_group', String)
    ...
    __eq_values__ = ['id', 'display_name', 'format_name', 'link', 'apo_namespace', 'namespace_group', 'description', 'date_created', 'created_by', 'apoid']
