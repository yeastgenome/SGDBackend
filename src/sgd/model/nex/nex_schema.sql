...
FILE_EXTENSION VARCHAR2(20) NOT NULL CHECK (FILE_EXTENSION IN ('tsv','xls','xlsx','gff','bed','pcl','pdf','fasta','fsa','html','txt','xml','jpg','doc','docx')),
...
CREATE INDEX ARCHPROTSEQANNO_CssTG_FK_INDEX ON ARCH_PROTEINSEQANNOTATION (CONTIG_ID) TABLESPACE DATA04;
