...
SGDID_STATUS VARCHAR2(40) NOT NULL CHECK (SGDID_STATUS IN ('Primary','Secondary','Deleted',)),
DESCRIPTION VARCHAR2(1000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
RELATION_TYPE VARCHAR2(40) NOT NULL CHECK (RELATION_TYPE IN ('is a','has part','has role')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT CHEMICAL_RELATION_PK PRIMARY KEY (RELATION_ID),
CONSTRAINT CHEMICAL_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_TYPE)) TABLESPACE DATA02;
...
CONSTRAINT EVIDENCE_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_TYPE)) TABLESPACE DATA02;
...
CONSTRAINT OBINVESTIGATION_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_TYPE)) TABLESPACE DATA02;
...
CONSTRAINT SEQUENCEFEATURE_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_TYPE)) TABLESPACE DATA02;
...
CONSTRAINT TAXONOMY_RELATION_UK UNIQUE (PARENT_ID, CHILD_ID, RELATION_TYPE)) TABLESPACE DATA02;
...
BUD_ID INTEGER,
LOCUS_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('External identifier','CGI','SGDID','Systematic name')),
...
CONSTRAINT LOCUS_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_TYPE)) TABLESPACE DATA02;
...
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('Download','GenBank','PubMed','Source','Wiki')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
ALIAS_TYPE VARCHAR2(40) NOT NULL CHECK (ALIAS_TYPE IN ('SGDID Primary','SGDID Secondary')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
