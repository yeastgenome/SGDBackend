...
CREATE INDEX SEQFEAT_SOURCE_FK_INDEX ON SO (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE SO
...
CREATE INDEX SEQFEAT_ALIAS_SOURCE_FK_INDEX ON SO_ALIAS (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE SO_ALIAS
ADD CONSTRAINT SEQFEAT_ALIAS_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE SO_ALIAS
ADD CONSTRAINT SEQFEAT_ALIAS_SEQFEAT_FK FOREIGN KEY (SO_ID) REFERENCES SO (SO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX SEQFEAT_URL_SOURCE_FK_INDEX ON SO_URL (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE SO_URL
ADD CONSTRAINT SEQFEAT_URL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE SO_URL
ADD CONSTRAINT SEQFEAT_URL_SEQFEAT_FK FOREIGN KEY (SO_ID) REFERENCES SO (SO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX SEQFEAT_REL_CHILD_FK_INDEX ON SO_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX SEQFEAT_REL_RO_FK_INDEX ON SO_RELATION (RO_ID) TABLESPACE DATA02;
CREATE INDEX SEQFEAT_REL_SOURCE_FK_INDEX ON SO_RELATION (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE SO_RELATION
ADD CONSTRAINT SEQFEAT_REL_CHILD_FK FOREIGN KEY (CHILD_ID) REFERENCES SO (SO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE SO_RELATION
ADD CONSTRAINT SEQFEAT_REL_PARENT_FK FOREIGN KEY (PARENT_ID) REFERENCES SO (SO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE SO_RELATION
ADD CONSTRAINT SEQFEAT_REL_RO_FK FOREIGN KEY (RO_ID) REFERENCES RO (RO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE SO_RELATION
