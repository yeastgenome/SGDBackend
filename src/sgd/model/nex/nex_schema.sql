...
FORMAT_NAME VARCHAR2(5) NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL,
OBJ_URL VARCHAR2(500),
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
...
CONSTRAINT POSTTRANSLATIONALANNOTATION_UK UNIQUE (DBENTITY_ID, TYPE, SITE_RESIDUE, SITE_INDEX, REFERENCE_ID) ) TABLESPACE DATA08;
CREATE INDEX PTRANSEV_REF_FK_INDEX ON POSTTRANSLATIONALANNOTATION (REFERENCE_ID) TABLESPACE DATA08;
CREATE INDEX PTRANSEV_ORGANISM_FK_INDEX ON POSTTRANSLATIONALANNOTATION (ORGANISM_ID) TABLESPACE DATA08;
CREATE INDEX PTRANSEV_EVIDENCE_FK_INDEX ON POSTTRANSLATIONALANNOTATION (EVIDENCE_ID) TABLESPACE DATA08;
CREATE INDEX PTRANSEV_SOURCE_FK_INDEX ON POSTTRANSLATIONALANNOTATION (SOURCE_ID) TABLESPACE DATA08;
CREATE INDEX PTRANSEV_DBENTITY_FK_INDEX ON POSTTRANSLATIONALANNOTATION (DBENTITY_ID) TABLESPACE DATA08;
ALTER TABLE POSTTRANSLATIONALANNOTATION
ADD CONSTRAINT PTRANSEV_ANNOT_FK FOREIGN KEY (ANNOTATION_ID) REFERENCES ANNOTATION (ANNOTATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE POSTTRANSLATIONALANNOTATION
ADD CONSTRAINT PTRANSEV_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE POSTTRANSLATIONALANNOTATION
ADD CONSTRAINT PTRANSEV_ORGANISM_FK FOREIGN KEY (ORGANISM_ID) REFERENCES ORGANISMDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE POSTTRANSLATIONALANNOTATION
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE POSTTRANSLATIONALANNOTATION
ADD CONSTRAINT PTRANSEV_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
