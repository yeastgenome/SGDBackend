...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT COLLEAGUE_PK PRIMARY KEY (COLLEAGUE_ID) ) TABLESPACE DATA04;
...
CREATE INDEX ENZANN_REF_FK_INDEX ON ENZYMEANNOTATION (REFERENCE_ID) TABLESPACE DATA08;
CREATE INDEX ENZANN_STRAIN_FK_INDEX ON ENZYMEANNOTATION (STRAIN_ID) TABLESPACE DATA08;
CREATE INDEX ENZANN_EXPT_FK_INDEX ON ENZYMEANNOTATION (EXPERIMENT_ID) TABLESPACE DATA08;
CREATE INDEX ENZANN_SOURCE_FK_INDEX ON ENZYMEANNOTATION (SOURCE_ID) TABLESPACE DATA08;
CREATE INDEX ENZANN_DBENT_FK_INDEX ON ENZYMEANNOTATION (DBENTITY_ID) TABLESPACE DATA08;
CREATE INDEX ENZANN_BIOCON_FK_INDEX ON ENZYMEANNOTATION (BIOCONCEPT_ID) TABLESPACE DATA08;
...
CREATE INDEX GENINTEV_DBENT1_INDEX ON GENINTERACTIONANNOTATION (DBENTITY1_ID) TABLESPACE DATA07;
...
CREATE INDEX PHYSINTEV_DBENT1_INDEX ON PHYSINTERACTIONANNOTATION (DBENTITY1_ID) TABLESPACE DATA07;
...
CONSTRAINT REGULATIONANNOTATION_UK UNIQUE (DBENTITY1_ID, DBENTITY2_ID, EXPERIMENT_ID, REFERENCE_ID, STRAIN_ID, CONDITIONS_KEY)) TABLESPACE DATA07;
...
CREATE INDEX REGEV_DBENT1_FK_INDEX ON REGULATIONANNOTATION (DBENTITY1_ID) TABLESPACE DATA07;
