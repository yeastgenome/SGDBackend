...
CREATE SEQUENCE CHANGE_SEQ NOCACHE;
...
DROP SEQUENCE DATASET_FILE_SEQ;
CREATE SEQUENCE DATASET_FILE_SEQ NOCACHE;

DROP SEQUENCE DATASET_KEYWORD_SEQ;
CREATE SEQUENCE DATASET_KEYWORD_SEQ NOCACHE;

DROP SEQUENCE DATASET_LAB_SEQ;
CREATE SEQUENCE DATASET_LAB_SEQ NOCACHE;

DROP SEQUENCE DATASET_REFERENCE_SEQ;
CREATE SEQUENCE DATASET_REFERENCE_SEQ NOCACHE;

DROP SEQUENCE DATASETSAMPLE_SEQ;
CREATE SEQUENCE DATASETSAMPLE_SEQ NOCACHE;
...
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('FILE','LOCUS','REFERENCE','STRAIN')),
...
TOPIC_ID VARCHAR2(100) NOT NULL,
OPERATION_ID VARCHAR2(100) NOT NULL,
FORMAT_ID VARCHAR2(100) NOT NULL,
EXTENSION_ID VARCHAR2(20) NOT NULL,
VERSION VARCHAR2(40) NOT NULL,
CONSTRAINT FILEDBENTITY_PK PRIMARY KEY (DBENTITY_ID),
CONSTRAINT FILEDBENTITY_UK UNIQUE (MD5SUM)) TABLESPACE DATA02;
CREATE INDEX FILEDBENT_TOPIC_FK_INDEX ON FILEDBENTITY (TOPIC_ID) TABLESPACE DATA02;
CREATE INDEX FILEDBENT_OPER_FK_INDEX ON FILEDBENTITY (OPERATION_ID) TABLESPACE DATA02;
CREATE INDEX FILEDBENT_FORMAT_FK_INDEX ON FILEDBENTITY (FORMAT_ID) TABLESPACE DATA02;
CREATE INDEX FILEDBENT_EXT_FK_INDEX ON FILEDBENTITY (EXTENSION_ID) TABLESPACE DATA02;
ALTER TABLE FILEDBENTITY
ADD CONSTRAINT FILE_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID);
ALTER TABLE FILEDBENTITY
ADD CONSTRAINT FILEDBENT_TOPIC_FK FOREIGN KEY (TOPIC_ID) REFERENCES EDAM (EDAM_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE FILEDBENTITY
ADD CONSTRAINT FILEDBENT_OPER_FK FOREIGN KEY (OPERATION_ID) REFERENCES EDAM (EDAM_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE FILEDBENTITY
ADD CONSTRAINT FILEDBENT_FORMAT_FK FOREIGN KEY (FORMAT_ID) REFERENCES EDAM (EDAM_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE FILEDBENTITY
ADD CONSTRAINT FILEDBENT_EXT_FK FOREIGN KEY (EXTENSION_ID) REFERENCES EDAM (EDAM_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
DBXREF_TYPE VARCHAR2(40) CHECK (DBXREF_TYPE IN ('GEO', 'ArrayExpress', 'SRA', 'Trace Archive')),
FILE_ID INTEGER,
...
CREATE INDEX DATASET_FILE_FK_INDEX ON DATASET (FILE_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASET
ADD CONSTRAINT DATASET_FILE_FK FOREIGN KEY (FILE_ID) REFERENCES FILEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASET
...
DROP TABLE DATASET_LAB CASCADE CONSTRAINTS;
CREATE TABLE DATASET_LAB (
DATASET_LAB_ID INTEGER NOT NULL,
DATASET_ID INTEGER NOT NULL,
SOURCE_ID INTEGER NOT NULL,
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT DATASET_LAB_PK PRIMARY KEY (DATASET_LAB_ID),
CONSTRAINT DATASET_LAB_UK UNIQUE (LAB_NAME, DATASET_ID)) TABLESPACE DATA02;
CREATE INDEX DATASET_LAB_DATASET_FK_INDEX ON DATASET_LAB (DATASET_ID) TABLESPACE DATA02;
CREATE INDEX DATASET_LAB_COLL_FK_INDEX ON DATASET_LAB (COLLEAGUE_ID) TABLESPACE DATA02;
ALTER TABLE DATASET_LAB
ADD CONSTRAINT DATASET_LAB_COLL_FK FOREIGN KEY (COLLEAGUE_ID) REFERENCES COLLEAGUE (COLLEAGUE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASET_LAB
ADD CONSTRAINT DATASET_LAB_DATASET_FK FOREIGN KEY (DATASET_ID) REFERENCES DATASET (DATASET_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON DATASET_LAB TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON DATASET_LAB TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON DATASET_LAB TO AUXILIARY;
...
CONSTRAINT DATASET_FILE_UK UNIQUE (FILE_ID, DATASET_ID)) TABLESPACE DATA02;
CREATE INDEX DATASET_FILE_SOURCE_FK_INDEX ON DATASET_FILE (SOURCE_ID) TABLESPACE DATA02;
CREATE INDEX DATASET_FILE_DATASET_FK_INDEX ON DATASET_FILE (DATASET_ID) TABLESPACE DATA02;
...
DBXREF_TYPE VARCHAR2(40) CHECK (DBXREF_TYPE IN ('GEO', 'ArrayExpress', 'SRA', 'Trace Archive')),
FILE_ID INTEGER,
BIOSAMPLE1_ID INTEGER,
BIOSAMPLE2_ID INTEGER,
STRAIN_CHANNEL1_ID INTEGER,
STRAIN_CHANNEL2_ID INTEGER,
...
CREATE INDEX DSETSAMP_FILE_FK_INDEX ON DATASETSAMPLE (FILE_ID) TABLESPACE DATA02;
CREATE INDEX DSETSAMP_BIOSAMP1_FK_INDEX ON DATASETSAMPLE (BIOSAMPLE1_ID) TABLESPACE DATA02;
CREATE INDEX DSETSAMP_BIOSAMP2_FK_INDEX ON DATASETSAMPLE (BIOSAMPLE2_ID) TABLESPACE DATA02;
CREATE INDEX DSETSAMP_STRAIN1_FK_INDEX ON DATASETSAMPLE (STRAIN_CHANNEL1_ID) TABLESPACE DATA02;
CREATE INDEX DSETSAMP_STRAIN2_FK_INDEX ON DATASETSAMPLE (STRAIN_CHANNEL2_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASETSAMPLE
ADD CONSTRAINT DSETSAMP_FILE_FK FOREIGN KEY (FILE_ID) REFERENCES FILEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASETSAMPLE
ADD CONSTRAINT DSETSAMP_BIOSAMP1_FK FOREIGN KEY (BIOSAMPLE1_ID) REFERENCES OBI (OBI_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASETSAMPLE
ADD CONSTRAINT DSETSAMP_BIOSAMP2_FK FOREIGN KEY (BIOSAMPLE2_ID) REFERENCES OBI (OBI_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASETSAMPLE
ADD CONSTRAINT DSETSAMP_STRAIN1_FK FOREIGN KEY (STRAIN_CHANNEL1_ID) REFERENCES TAXONOMY (TAXONOMY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASETSAMPLE
ADD CONSTRAINT DSETSAMP_STRAIN2_FK FOREIGN KEY (STRAIN_CHANNEL2_ID) REFERENCES TAXONOMY (TAXONOMY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT PHENOTYPEANNOTATION_UK UNIQUE (DBENTITY_ID,PHENOTYPE_ID,TAXONOMY_ID,EXPERIMENT_ID,REFERENCE_ID,MUTANT_ID,ALLELE_ID,REPORTER_ID,ASSAY_ID) ) TABLESPACE DATA03;
...
CONDITION_TYPE VARCHAR2(40) NOT NULL,
CONDITION_VALUE VARCHAR2(500) NOT NULL,
CONDITION_UNIT VARCHAR2(40),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT PHENOTYPEANNOTATION_COND_PK PRIMARY KEY (CONDITION_ID),
CONSTRAINT PHENOTYPEANNOTATION_COND_UK UNIQUE (ANNOTATION_ID, CONDITION_CLASS, GROUP_ID, CONDITION_TYPE, CONDITION_VALUE) ) TABLESPACE DATA03;
...
CREATE INDEX PROTEXPTANNO_OBI_FK_INDEX ON PROTEINEXPTANNOTATION (OBI_ID) TABLESPACE DATA03;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE PROTEINEXPTANNOTATION
ADD CONSTRAINT PROTEXPTANNO_OBI_FK FOREIGN KEY (OBI_ID) REFERENCES OBI (OBI_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE PROTEINEXPTANNOTATION
...
CONSTRAINT PROTEINEXPTANNOTATION_COND_UK UNIQUE (ANNOTATION_ID, CONDITION_CLASS, GROUP_ID, CONDITION_TYPE, CONDITION_VALUE) ) TABLESPACE DATA03;
...
CURATION_TAG VARCHAR2(40) NOT NULL,
CURATION_NOTE VARCHAR2(2000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT CURATION_PK PRIMARY KEY (CURATION_ID),
CONSTRAINT CURATION_UK UNIQUE (DBENTITY_ID, SUBCLASS, CURATION_TAG) ) TABLESPACE DATA01;
...
HAS_NOVEL_RESEARCH NUMBER(1) NOT NULL,
HAS_LARGE_SCALE_DATA NUMBER(1) NOT NULL,
HAS_FAST_TRACK_TAG NUMBER(1) NOT NULL,
CURATOR_CHECKED_DATASETS NUMBER(1) NOT NULL,
CURATOR_CHECKED_GENELIST NUMBER(1) NOT NULL,
NO_ACTION_REQUIRED  NUMBER(1) NOT NULL,
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT AUTHORRESPONSE_PK PRIMARY KEY (AUTHORRESPONSE_ID),
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT REFERENCETRIAGE_PK PRIMARY KEY (REFERENCETRIAGE_ID),
...
CHANGED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
DATE_ARCHIVED DATE DEFAULT SYSDATE NOT NULL,
CONSTRAINT ARCH_LOCUSCHANGE_PK PRIMARY KEY (CHANGE_ID),
CONSTRAINT ARCH_LOCUSCHANGE_UK UNIQUE (LOCUS_ID, CHANGE_TYPE, OLD_VALUE, NEW_VALUE, DATE_CHANGE_MADE) ) TABLESPACE DATA04;
CREATE INDEX ARCHLOCUSCHG_SOURCE_FK_INDEX ON ARCH_LOCUSCHANGE (SOURCE_ID) TABLESPACE DATA04;
ALTER TABLE ARCH_LOCUSCHANGE
ADD CONSTRAINT ARCHLOCUSCHG_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_LOCUSCHANGE
ADD CONSTRAINT ARCHLOCUSCHG_LOCUS_FK FOREIGN KEY (LOCUS_ID) REFERENCES LOCUSDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX ARCHLITANNO_REF_FK_INDEX ON ARCH_LITERATUREANNOTATION (REFERENCE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHLITANNO_TAX_FK_INDEX ON ARCH_LITERATUREANNOTATION (TAXONOMY_ID) TABLESPACE DATA04;
CREATE INDEX ARCHLITANNO_SOURCE_FK_INDEX ON ARCH_LITERATUREANNOTATION (SOURCE_ID) TABLESPACE DATA04;
ALTER TABLE ARCH_LITERATUREANNOTATION
ADD CONSTRAINT ARCHLITANNO_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_LITERATUREANNOTATION
ADD CONSTRAINT ARCHLITANNO_TAX_FK FOREIGN KEY (TAXONOMY_ID) REFERENCES TAXONOMY (TAXONOMY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_LITERATUREANNOTATION
ADD CONSTRAINT ARCHLITANNO_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_LITERATUREANNOTATION
ADD CONSTRAINT ARCHLITANNO_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
LOB (RESIDUES) store as SECUREFILE (TABLESPACE LOB01
enable storage in row CHUNK 8K nocache nologging retention none);
CREATE INDEX ARCHCONTIG_SOURCE_FK_INDEX ON ARCH_CONTIG (SOURCE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHCONTIG_TAX_FK_INDEX ON ARCH_CONTIG (TAXONOMY_ID) TABLESPACE DATA04;
CREATE INDEX ARCHCONTIG_SO_FK_INDEX ON ARCH_CONTIG (SO_ID) TABLESPACE DATA04;
CREATE INDEX ARCHCONTIG_GENREL_FK_INDEX ON ARCH_CONTIG (GENOMERELEASE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHCONTIG_FILE_FK_INDEX ON ARCH_CONTIG (FILE_ID) TABLESPACE DATA04;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_CONTIG
ADD CONSTRAINT ARCHCONTIG_SO_FK FOREIGN KEY (SO_ID) REFERENCES SO (SO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_CONTIG
ADD CONSTRAINT ARCHCONTIG_GENREL_FK FOREIGN KEY (GENOMERELEASE_ID) REFERENCES GENOMERELEASE (GENOMERELEASE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_CONTIG
ADD CONSTRAINT ARCHCONTIG_FILE_FK FOREIGN KEY (FILE_ID) REFERENCES FILEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CHANGED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
DATE_ARCHIVED DATE DEFAULT SYSDATE NOT NULL,
CONSTRAINT ARCH_CONTIGCHANGE_PK PRIMARY KEY (CHANGE_ID) ) TABLESPACE DATA04;
CREATE INDEX ARCHCONTIGCHG_CONTIG_FK_INDEX ON ARCH_CONTIGCHANGE (CONTIG_ID) TABLESPACE DATA04;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_CONTIGCHANGE
ADD CONSTRAINT ARCHCONTIGCHG_GENREL_FK FOREIGN KEY (GENOMERELEASE_ID) REFERENCES GENOMERELEASE (GENOMERELEASE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT ARCH_DNASEQUENCEANNOTATION_UK UNIQUE (DBENTITY_ID, TAXONOMY_ID, CONTIG_ID, SO_ID, DNA_TYPE) ) TABLESPACE DATA04
LOB (RESIDUES) store as SECUREFILE (TABLESPACE LOB01
enable storage in row CHUNK 8K nocache nologging retention none);
CREATE INDEX ARCHDNASEQANNO_TAX_FK_INDEX ON ARCH_DNASEQUENCEANNOTATION (TAXONOMY_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_REF_FK_INDEX ON ARCH_DNASEQUENCEANNOTATION (REFERENCE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_SOURCE_FK_INDEX ON ARCH_DNASEQUENCEANNOTATION (SOURCE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_CONTIG_FK_INDEX ON ARCH_DNASEQUENCEANNOTATION (CONTIG_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_SO_FK_INDEX ON ARCH_DNASEQUENCEANNOTATION (SO_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_GENREL_FK_INDEX ON ARCH_DNASEQUENCEANNOTATION (GENOMERELEASE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_FILE_FK_INDEX ON ARCH_DNASEQUENCEANNOTATION (FILE_ID) TABLESPACE DATA04;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASEQUENCEANNOTATION
ADD CONSTRAINT ARCHDNASEQANNO_TAX_FK FOREIGN KEY (TAXONOMY_ID) REFERENCES TAXONOMY (TAXONOMY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASEQUENCEANNOTATION
ADD CONSTRAINT ARCHDNASEQANNO_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASEQUENCEANNOTATION
ADD CONSTRAINT ARCHDNASEQANNO_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASEQUENCEANNOTATION
ADD CONSTRAINT ARCHDNASEQANNO_CONTIG_FK FOREIGN KEY (CONTIG_ID) REFERENCES CONTIG (CONTIG_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASEQUENCEANNOTATION
ADD CONSTRAINT ARCHDNASEQANNO_SO_FK FOREIGN KEY (SO_ID) REFERENCES SO (SO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASEQUENCEANNOTATION
ADD CONSTRAINT ARCHDNASEQANNO_GENREL_FK FOREIGN KEY (GENOMERELEASE_ID) REFERENCES GENOMERELEASE (GENOMERELEASE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASEQUENCEANNOTATION
ADD CONSTRAINT ARCHDNASEQANNO_FILE_FK FOREIGN KEY (FILE_ID) REFERENCES FILEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT ARCH_DNASUBSEQUENCE_UK UNIQUE (ANNOTATION_ID, DBENTITY_ID, RELATIVE_START_INDEX, RELATIVE_END_INDEX)) TABLESPACE DATA04
LOB (RESIDUES) store as SECUREFILE (TABLESPACE LOB01
enable storage in row CHUNK 8K nocache nologging retention none);
...
ADD CONSTRAINT ARCHDNASUBSEQ_ANNO_FK FOREIGN KEY (ANNOTATION_ID) REFERENCES ARCH_DNASEQUENCEANNOTATION (ANNOTATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASUBSEQUENCE
ADD CONSTRAINT ARCHDNASUBSEQ_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASUBSEQUENCE
ADD CONSTRAINT ARCHDNASUBSEQ_SO_FK FOREIGN KEY (SO_ID) REFERENCES SO (SO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASUBSEQUENCE
ADD CONSTRAINT ARCHDNASUBSEQ_GENREL_FK FOREIGN KEY (GENOMERELEASE_ID) REFERENCES GENOMERELEASE (GENOMERELEASE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASUBSEQUENCE
ADD CONSTRAINT ARCHDNASUBSEQ_FILE_FK FOREIGN KEY (FILE_ID) REFERENCES FILEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT ARCH_PROTEINSEQANNOTATION_UK UNIQUE (DBENTITY_ID, TAXONOMY_ID, CONTIG_ID) ) TABLESPACE DATA04
LOB (RESIDUES) store as SECUREFILE (TABLESPACE LOB01
enable storage in row CHUNK 8K nocache nologging retention none);
CREATE INDEX ARCHPROTSEQANNO_TAX_FK_INDEX ON ARCH_PROTEINSEQUENCEANNOTATION (TAXONOMY_ID) TABLESPACE DATA04;
CREATE INDEX ARCHPROTSEQANNO_REF_FK_INDEX ON ARCH_PROTEINSEQUENCEANNOTATION (REFERENCE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHPROTSEQANNO_SOURCE_FK_IDX ON ARCH_PROTEINSEQUENCEANNOTATION (SOURCE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHPROTSEQANNO_CONTIG_FK_IDX ON ARCH_PROTEINSEQUENCEANNOTATION (CONTIG_ID) TABLESPACE DATA04;
CREATE INDEX ARCHPROTSEQANNO_GENREL_FK_IDX ON ARCH_PROTEINSEQUENCEANNOTATION (GENOMERELEASE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHPROTSEQANNO_FILE_FK_INDEX ON ARCH_PROTEINSEQUENCEANNOTATION (FILE_ID) TABLESPACE DATA04;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_PROTEINSEQUENCEANNOTATION
ADD CONSTRAINT ARCHPROTSEQANNO_CONTIG_FK FOREIGN KEY (CONTIG_ID) REFERENCES CONTIG (CONTIG_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_PROTEINSEQUENCEANNOTATION
ADD CONSTRAINT ARCHPROTSEQANNO_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_PROTEINSEQUENCEANNOTATION
ADD CONSTRAINT ARCHPROTSEQANNO_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_PROTEINSEQUENCEANNOTATION
ADD CONSTRAINT ARCHPROTSEQANNO_GENREL_FK FOREIGN KEY (GENOMERELEASE_ID) REFERENCES GENOMERELEASE (GENOMERELEASE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_PROTEINSEQUENCEANNOTATION
ADD CONSTRAINT ARCHPROTSEQANNO_FILE_FK FOREIGN KEY (FILE_ID) REFERENCES FILEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
