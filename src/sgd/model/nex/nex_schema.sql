...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
DROP SEQUENCE ORGANISM_SEQ;
CREATE SEQUENCE ORGANISM_SEQ NOCACHE;
...
DROP TABLE STRAINORGANISM CASCADE CONSTRAINTS;
CREATE TABLE STRAINORGANISM (
ORGANISM_ID INTEGER NOT NULL,
CATEGORY VARCHAR2(40),
...
CONSTRAINT STRAINORGANISM_PK PRIMARY KEY (ORGANISM_ID)) TABLESPACE DATA1;
ALTER TABLE STRAINORGANISM
ADD CONSTRAINT STRAINORGANISM_ORGANISM_FK FOREIGN KEY (ORGANISM_ID) REFERENCES ORGANISM (ORGANISM_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON STRAINORGANISM TO DBSELECT;
GRANT INSERT, SELECT, UPDATE ON STRAINORGANISM TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON STRAINORGANISM TO AUXILIARY;

DROP TABLE ORGANISM_URL CASCADE CONSTRAINTS;
CREATE TABLE ORGANISM_URL (
ORGANISM_URL_ID INTEGER NOT NULL,
FORMAT_NAME VARCHAR2(100) NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL,
OBJ_URL VARCHAR2(500) NOT NULL,
SOURCE_ID INTEGER NOT NULL,
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT ORGANISM_URL_PK PRIMARY KEY (ORGANISM_URL_ID),
CONSTRAINT ORGANISM_URL_UK UNIQUE (ORGANISM_ID, DISPLAY_NAME, CATEGORY) ) TABLESPACE DATA1;
DROP SEQUENCE ORGANISM_URL_SEQ;
CREATE SEQUENCE ORGANISM_URL_SEQ NOCACHE;
CREATE INDEX ORGANISM_URL_SOURCE_FK_INDEX ON ORGANISM_URL (SOURCE_ID) TABLESPACE DATA1;
ALTER TABLE ORGANISM_URL
ADD CONSTRAINT ORGANISM_URL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
CREATE INDEX ORGANISM_URL_ORGANISM_FK_INDEX ON ORGANISM_URL (ORGANISM_ID) TABLESPACE DATA1;
ALTER TABLE ORGANISM_URL
ADD CONSTRAINT ORGANISM_URL_ORGANISM_FK FOREIGN KEY (ORGANISM_ID) REFERENCES ORGANISM (ORGANISM_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ORGANISM_RELATION_ID INTEGER NOT NULL,
FORMAT_NAME VARCHAR2(100) NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL,
OBJ_URL VARCHAR2(500) NOT NULL,
SOURCE_ID INTEGER NOT NULL,
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT ORGANISM_RELATION_PK PRIMARY KEY (ORGANISM_RELATION_ID),
CONSTRAINT ORGANISM_RELATION_UK UNIQUE (RELATION_TYPE, PARENT_ID, CHILD_ID) ) TABLESPACE DATA1;
DROP SEQUENCE ORGANISM_RELATION_SEQ;
CREATE SEQUENCE ORGANISM_RELATION_SEQ NOCACHE;
CREATE INDEX ORGANISM_REL_SOURCE_FK_INDEX ON ORGANISM_RELATION (SOURCE_ID) TABLESPACE DATA1;
ALTER TABLE ORGANISM_RELATION
ADD CONSTRAINT ORGANISM_REL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
CREATE INDEX ORGANISM_REL_CHILD_FK_INDEX ON ORGANISM_RELATION (CHILD_ID) TABLESPACE DATA1;
ALTER TABLE ORGANISM_RELATION
ADD CONSTRAINT ORGANISM_REL_CHILD_FK FOREIGN KEY (CHILD_ID) REFERENCES ORGANISM (ORGANISM_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
CREATE INDEX ORGANISM_REL_PARENT_FK_INDEX ON ORGANISM_RELATION (PARENT_ID) TABLESPACE DATA1;
ALTER TABLE ORGANISM_RELATION
ADD CONSTRAINT ORGANISM_REL_PARENT_FK FOREIGN KEY (PARENT_ID) REFERENCES ORGANISM (ORGANISM_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
