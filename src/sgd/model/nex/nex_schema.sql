...
DROP SEQUENCE COLLEAGUE_FORMAT_NAME_SEQ;
CREATE SEQUENCE COLLEAGUE_FORMAT_NAME_SEQ NOCACHE;
...
CREATE SEQUENCE GROUP_SEQ NOCACHE;
...
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
DBXREF_TYPE VARCHAR2(40) NOT NULL,
DESCRIPTION VARCHAR2(1000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT DBXREF_PK PRIMARY KEY (DBXREF_ID),
CONSTRAINT DBXREF_UK UNIQUE (FORMAT_NAME) ) TABLESPACE DATA01;
CREATE INDEX DBXREF_SOURCE_FK_INDEX ON DBXREF (SOURCE_ID) TABLESPACE DATA01;
ALTER TABLE DBXREF
ADD CONSTRAINT DBXREF_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON DBXREF TO DBSELECT;
GRANT INSERT, SELECT, UPDATE ON DBXREF TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON DBXREF TO AUXILIARY;
...
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
EC_NUMBER VARCHAR2(20) NOT NULL,
DESCRIPTION VARCHAR2(1000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT EC_PK PRIMARY KEY (EC_ID),
CONSTRAINT EC_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE UNIQUE INDEX ECNUMBER_UK_INDEX on EC (EC_NUMBER) TABLESPACE DATA02;
...
CREATE INDEX LOCUS_SO_FK_INDEX ON LOCUSDBENTITY (SO_ID) TABLESPACE DATA02;
ALTER TABLE LOCUSDBENTITY
ADD CONSTRAINT LOCUS_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LOCUSDBENTITY
ADD CONSTRAINT LOCUS_SO_FK FOREIGN KEY (SO_ID) REFERENCES SO (SO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX CONTIG_GENREL_FK_INDEX ON CONTIG (GENOMERELEASE_ID) TABLESPACE DATA11;
ALTER TABLE CONTIG
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE CONTIG
ADD CONSTRAINT CONTIG_FILE_FK FOREIGN KEY (FILE_ID) REFERENCES FILE (FILE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT BINDINGANNOTATION_UK UNIQUE (DBENTITY_ID, MOTIF_ID) ) TABLESPACE DATA03;
CREATE INDEX BINDANNO_REF_FK_INDEX ON BINDINGANNOTATION (REFERENCE_ID) TABLESPACE DATA03;
CREATE INDEX BINDANNO_TAX_FK_INDEX ON BINDINGANNOTATION (TAXONOMY_ID) TABLESPACE DATA03;
CREATE INDEX BINDANNO_SOURCE_FK_INDEX ON BINDINGANNOTATION (SOURCE_ID) TABLESPACE DATA03;
...
CONSTRAINT DNASEQUENCEANNOTATION_UK UNIQUE (DBENTITY_ID, TAXONOMY_ID, DNA_TYPE) ) TABLESPACE DATA03;
...
CREATE INDEX DNASEQANNO_GENRELEASE_FK_INDEX ON DNASEQUENCEANNOTATION (GENOMERELEASE_ID) TABLESPACE DATA03;
...
CONSTRAINT DNASEQUENCE_EXTENSION_UK UNIQUE (ANNOTATION_ID, EXTENSION_TYPE, RELATIVE_START_INDEX, RELATIVE_END_INDEX)) TABLESPACE DATA03;
CREATE INDEX DNASEQEXT_DBENTITY_FK_INDEX ON DNASEQUENCE_EXTENSION (LOCUS_ID) TABLESPACE DATA03;
CREATE INDEX DNASEQEXT_GENRELEASE_FK_INDEX ON DNASEQUENCE_EXTENSION (GENOMERELEASE_ID) TABLESPACE DATA03;
...
CREATE INDEX ENZYMEANNO_REF_FK_INDEX ON ENZYMEANNOTATION (REFERENCE_ID) TABLESPACE DATA03;
CREATE INDEX ENZYMEANNO_TAX_FK_INDEX ON ENZYMEANNOTATION (TAXONOMY_ID) TABLESPACE DATA03;
CREATE INDEX ENZYMEANNO_SOURCE_FK_INDEX ON ENZYMEANNOTATION (SOURCE_ID) TABLESPACE DATA03;
CREATE INDEX ENZYMEANNO_EC_FK_INDEX ON ENZYMEANNOTATION	(EC_ID) TABLESPACE DATA03;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ENZYMEANNOTATION
ADD CONSTRAINT ENZYMEANNO_EC_FK FOREIGN KEY (EC_ID) REFERENCES EC (EC_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT EXPRESSIONANNOTATION_UK UNIQUE (DATASETSAMPLE_ID)) TABLESPACE DATA03;
...
CREATE INDEX EXPRESSANNO_DBENTITY_FK_INDEX ON EXPRESSIONANNOTATION (DBENTITY_ID) TABLESPACE DATA03;
...
CONSTRAINT GENINTERACTIONANNOTATION_UK UNIQUE (DBENTITY1_ID, DBENTITY2_ID, BAIT_HIT, EXPERIMENT_ID, REFERENCE_ID)) TABLESPACE DATA03;
...
CREATE INDEX GENINTANNO_EX_FK_INDEX ON GENINTERACTIONANNOTATION (EXPERIMENT_ID) TABLESPACE DATA03;
...
CONSTRAINT GOANNOTATION_UK UNIQUE (LOCUS_ID, GO_ID, ECO_ID, REFERENCE_ID, ANNOTATION_TYPE, GO_QUALIFIER, SOURCE_ID)) TABLESPACE DATA03;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE GOANNOTATION
ADD CONSTRAINT GOANNO_LOCUS_FK FOREIGN KEY (LOCUS_ID) REFERENCES LOCUSDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE GOANNOTATION
...
OPERATOR VARCHAR2(10) NOT NULL CHECK (OPERATOR IN ('AND', 'OR')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT GOSUPPORTINGEVIDENCE_PK PRIMARY KEY (GOSUPPORTINGEVIDENCE_ID),
CONSTRAINT GOSUPPORTINGEVIDENCE_UK UNIQUE (ANNOTATION_ID, DBXREF_ID, GROUP_ID, EVIDENCE_TYPE, OPERATOR)) TABLESPACE DATA03;
CREATE INDEX GOSUPEVID_DBXREF_FK_INDEX ON GOSUPPORTINGEVIDENCE (DBXREF_ID) TABLESPACE DATA03;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE GOSUPPORTINGEVIDENCE
ADD CONSTRAINT GOSUPEVID_DBXREF_FK FOREIGN KEY (DBXREF_ID) REFERENCES DBXREF (DBXREF_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT GOEXTENSION_UK UNIQUE (ANNOTATION_ID, DBXREF_ID, GROUP_ID, RO_ID, OPERATOR)) TABLESPACE DATA03;
CREATE INDEX GOEXT_DBXREF_FK_INDEX ON GOEXTENSION (DBXREF_ID) TABLESPACE DATA03;
CREATE INDEX GOEXT_RO_FK_INDEX ON GOEXTENSION (RO_ID) TABLESPACE DATA03;
ALTER TABLE GOEXTENSION
ADD CONSTRAINT GOEXT_DBXREF_FK FOREIGN KEY (DBXREF_ID) REFERENCES DBXREF (DBXREF_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE GOEXTENSION
...
CONSTRAINT GOSLIMANNOTATION_UK UNIQUE (LOCUS_ID, GOSLIM_ID)) TABLESPACE DATA03;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE GOSLIMANNOTATION
ADD CONSTRAINT GOSLIMANNO_LOCUS_FK FOREIGN KEY (LOCUS_ID) REFERENCES LOCUSDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE GOSLIMANNOTATION
...
CONSTRAINT HISTORYANNOTATION_UK UNIQUE (DBENTITY_ID, SUBCLASS, REFERENCE_ID, HISTORY_NOTE) ) TABLESPACE DATA03;
CREATE INDEX HISTANNO_REF_FK_INDEX ON HISTORYANNOTATION (REFERENCE_ID) TABLESPACE DATA03;
CREATE INDEX HISTANNO_TAX_FK_INDEX ON HISTORYANNOTATION (TAXONOMY_ID) TABLESPACE DATA03;
CREATE INDEX HISTANNO_SOURCE_FK_INDEX ON HISTORYANNOTATION (SOURCE_ID) TABLESPACE DATA03;
...
CONSTRAINT LITERATUREANNOTATION_UK UNIQUE (LOCUS_ID, REFERENCE_ID, TOPIC) ) TABLESPACE DATA03;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LITERATUREANNOTATION 
ADD CONSTRAINT LITANNO_LOCUS_FK FOREIGN KEY (LOCUS_ID) REFERENCES LOCUSDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT PATHWAYANNOTATION_UK UNIQUE (DBENTITY_ID, PATHWAY_ID) ) TABLESPACE DATA03;
...
CONSTRAINT PHENOTYPEANNOTATION_UK UNIQUE (LOCUS_ID,PHENOTYPE_ID,TAXONOMY_ID,EXPERIMENT_ID,REFERENCE_ID,MUTANT_ID,ALLELE_ID,REPORTER_ID,ASSAY_ID,ANALYSIS_ID) ) TABLESPACE DATA04;
...
CREATE INDEX PHENOANNO_ANAL_FK_INDEX ON PHENOTYPEANNOTATION (ANALYSIS_ID) TABLESPACE DATA03;
ALTER TABLE PHENOTYPEANNOTATION
ADD CONSTRAINT PHENOANNO_LOCUS_FK FOREIGN KEY (LOCUS_ID) REFERENCES LOCUSDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE PHENOTYPEANNOTATION
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE PHENOTYPEANNOTATION
ADD CONSTRAINT PHENOANNO_ANAL_FK FOREIGN KEY (ANALYSIS_ID) REFERENCES OBI (OBI_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
DROP TABLE PHENOTYPEANNOTATION_DETAIL CASCADE CONSTRAINTS;
CREATE TABLE PHENOTYPEANNOTATION_DETAIL (
DETAIL_ID INTEGER NOT NULL,
ANNOTATION_ID INTEGER NOT NULL,
DETAIL_TYPE VARCHAR2(40) NOT NULL,
DETAIL_NAME VARCHAR2(40) NOT NULL,
DETAIL_VALUE VARCHAR2(500) NOT NULL,
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT PHENOTYPEANNOTATION_DETAIL_PK PRIMARY KEY (DETAIL_ID),
CONSTRAINT PHENOTYPEANNOTATION_DETAIL_UK UNIQUE (ANNOTATION_ID, DETAIL_TYPE, DETAIL_NAME, DETAIL_VALUE) ) TABLESPACE DATA03;
ALTER TABLE PHENOTYPEANNOTATION_DETAIL
ADD CONSTRAINT PHENOANNODET_ANNO_FK FOREIGN KEY (ANNOTATION_ID) REFERENCES PHENOTYPEANNOTATION (ANNOTATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON PHENOTYPEANNOTATION_DETAIL TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON PHENOTYPEANNOTATION_DETAIL TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON PHENOTYPEANNOTATION_DETAIL TO AUXILIARY;
...
CONSTRAINT POSTTRANSLATIONALANNOTATION_UK UNIQUE (DBENTITY_ID, POSTTRANS_TYPE, SITE_RESIDUE, SITE_INDEX, REFERENCE_ID) ) TABLESPACE DATA03;
CREATE INDEX PTRANSANNO_REF_FK_INDEX ON POSTTRANSLATIONALANNOTATION (REFERENCE_ID) TABLESPACE DATA03;
CREATE INDEX PTRANSANNO_TAX_FK_INDEX ON POSTTRANSLATIONALANNOTATION (TAXONOMY_ID) TABLESPACE DATA03;
CREATE INDEX PTRANSANNO_SOURCE_FK_INDEX ON POSTTRANSLATIONALANNOTATION (SOURCE_ID) TABLESPACE DATA03;
CREATE INDEX PTRANSANNO_MOD_FK_INDEX ON POSTTRANSLATIONALANNOTATION (MODIFIER_ID) TABLESPACE DATA03;
...
CONSTRAINT PHYSINTERACTIONANNOTATION_UK UNIQUE (DBENTITY1_ID, DBENTITY2_ID, BAIT_HIT, EXPERIMENT_ID, REFERENCE_ID)) TABLESPACE DATA03;
...
CREATE INDEX PHYSINTANNO_EX_FK_INDEX ON PHYSINTERACTIONANNOTATION (EXPERIMENT_ID) TABLESPACE DATA03;
...
CREATE INDEX DOMAINANNO_REF_FK_INDEX ON PROTEINDOMAINANNOTATION (REFERENCE_ID) TABLESPACE DATA03;
CREATE INDEX DOMAINANNO_TAX_FK_INDEX ON PROTEINDOMAINANNOTATION (TAXONOMY_ID) TABLESPACE DATA03;
CREATE INDEX DOMAINANNO_SOURCE_FK_INDEX ON PROTEINDOMAINANNOTATION (SOURCE_ID) TABLESPACE DATA03;
CREATE INDEX DOMAINANNO_DOMAIN_FK_INDEX ON PROTEINDOMAINANNOTATION (PROTEINDOMAIN_ID) TABLESPACE DATA03;
...
CONSTRAINT PROTEINEXPERIMENTANNOTATION_UK UNIQUE (DBENTITY_ID, EXPERIMENT_TYPE) ) TABLESPACE DATA03;
CREATE INDEX PROTEXPANNO_REF_FK_INDEX ON PROTEINEXPERIMENTANNOTATION (REFERENCE_ID) TABLESPACE DATA03;
CREATE INDEX PROTEXPANNO_TAX_FK_INDEX ON PROTEINEXPERIMENTANNOTATION (TAXONOMY_ID) TABLESPACE DATA03;
CREATE INDEX PROTEXPANNO_SOURCE_FK_INDEX ON PROTEINEXPERIMENTANNOTATION (SOURCE_ID) TABLESPACE DATA03;
...
CONSTRAINT PROTEINSEQUENCEANNOTATION_UK UNIQUE (DBENTITY_ID, TAXONOMY_ID) ) TABLESPACE DATA03;
...
CONSTRAINT FILE_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RO_ID)) TABLESPACE DATA02;
CREATE INDEX FILE_REL_CHILD_FK_INDEX ON FILE_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX FILE_REL_RO_FK_INDEX ON FILE_RELATION (RO_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE FILE_RELATION
ADD CONSTRAINT FILE_REL_RO_FK FOREIGN KEY (RO_ID) REFERENCES RO (RO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE FILE_RELATION
