...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT SGDID_PK PRIMARY KEY (SGDID) ) TABLESPACE DATA01;
CREATE INDEX SGDID_SOURCE_FK_INDEX ON SGDID (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE SGDID
...
CONSTRAINT RO_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_ONTOLOGY_ID)) TABLESPACE DATA02;
CREATE INDEX RO_REL_CHILD_FK_INDEX ON RO_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX RO_REL_RO_FK_INDEX ON RO_RELATION (RELATION_ONTOLOGY_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE RO_RELATION
ADD CONSTRAINT RO_REL_RO_FK FOREIGN KEY (RELATION_ONTOLOGY_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE RO_RELATION
...
CREATE INDEX DBENT_SGDID_FK_INDEX ON DBENTITY (SGDID) TABLESPACE DATA02;
ALTER TABLE DBENTITY
ADD CONSTRAINT DBENT_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DBENTITY
ADD CONSTRAINT DBENT_SGDID_FK FOREIGN KEY (SGDID) REFERENCES SGDID (SGDID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT REFERENCE_RELATION_UK UNIQUE(RELATION_TYPE, PARENT_ID, CHILD_ID)) TABLESPACE DATA02;
CREATE INDEX REF_REL_PARENT_FK_INDEX ON REFERENCE_RELATION (PARENT_ID) TABLESPACE DATA02;
CREATE INDEX REF_REL_CHILD_FK_INDEX ON REFERENCE_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX REF_REL_SOURCE_FK_INDEX ON REFERENCE_RELATION (SOURCE_ID) TABLESPACE DATA02;
