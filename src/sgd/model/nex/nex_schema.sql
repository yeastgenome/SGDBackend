...
CONSTRAINT PROTEINEXPTANNOTATION_UK UNIQUE (DBENTITY_ID, EXPERIMENT_TYPE) ) TABLESPACE DATA03;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE PROTEINEXPTANNOTATION
ADD CONSTRAINT PROTEXPTANNO_DBENTITY_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
