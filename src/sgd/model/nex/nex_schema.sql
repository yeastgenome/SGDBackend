...
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('PHENOTYPE', 'GO', 'ECNUMBER', 'GENINTERACTION', 'PHYSINTERACTION', 'BINDING', 'DOMAIN', 'LITERATURE', 'REGULATION', 'COMPLEX', 'DNASEQUENCE', 'PROTEINSEQUENCE', 'BIOENTITY', 'ALIAS')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL, 
...
ADD CONSTRAINT DOMAINEV_BIOENT_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES PROTEINBIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DOMAINEVIDENCE
...
CONSTRAINT REGULATIONEVIDENCE_UK UNIQUE (BIOENTITY1_ID, BIOENTITY2_ID, EXPERIMENT_ID, REFERENCE_ID, CONDITIONS_KEY)) TABLESPACE DATA2;
...
CONSTRAINT PROTEINEXPERIMENTEVIDENCE_UK UNIQUE (BIOENTITY_ID, DATA_TYPE) ) TABLESPACE DATA2;
...
GO_ID INTEGER,
NOTE VARCHAR2(1000) NULL,
CONSTRAINT COMPLEXEVIDENCE_PK PRIMARY KEY (EVIDENCE_ID),
CONSTRAINT COMPLEXEVIDENCE_UK UNIQUE (BIOENTITY_ID, COMPLEX_ID, GO_ID) ) TABLESPACE DATA2;
CREATE INDEX COMPEV_REF_FK_INDEX ON COMPLEXEVIDENCE (REFERENCE_ID) TABLESPACE DATA2;
CREATE INDEX COMPEV_STRAIN_FK_INDEX ON COMPLEXEVIDENCE (STRAIN_ID) TABLESPACE DATA2;
CREATE INDEX COMPEV_EXPT_FK_INDEX ON COMPLEXEVIDENCE (EXPERIMENT_ID) TABLESPACE DATA2;
CREATE INDEX COMPEV_SOURCE_FK_INDEX ON COMPLEXEVIDENCE (SOURCE_ID) TABLESPACE DATA2;
CREATE INDEX COMPEV_BIOENT_INDEX ON COMPLEXEVIDENCE (BIOENTITY_ID) TABLESPACE DATA2;
CREATE INDEX COMPEV_COMP_INDEX ON COMPLEXEVIDENCE (COMPLEX_ID) TABLESPACE DATA2;
CREATE INDEX COMPEV_GO_INDEX ON COMPLEXEVIDENCE (GO_ID) TABLESPACE DATA2;
ALTER TABLE COMPLEXEVIDENCE
ADD CONSTRAINT COMPEV_EV_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES EVIDENCE (EVIDENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE COMPLEXEVIDENCE
ADD CONSTRAINT COMPEV_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCE (REFERENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE COMPLEXEVIDENCE
ADD CONSTRAINT COMPEV_STRAIN_FK FOREIGN KEY (STRAIN_ID) REFERENCES STRAIN (STRAIN_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE COMPLEXEVIDENCE
ADD CONSTRAINT COMPEV_EXPT_FK FOREIGN KEY (EXPERIMENT_ID) REFERENCES EXPERIMENT (EXPERIMENT_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE COMPLEXEVIDENCE
ADD CONSTRAINT COMPEV_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE COMPLEXEVIDENCE
...
CONSTRAINT DNASEQUENCEEVIDENCE_UK UNIQUE (BIOENTITY_ID, STRAIN_ID) ) TABLESPACE DATA2;
...
CONSTRAINT PROTEINSEQUENCEEVIDENCE_UK UNIQUE (BIOENTITY_ID, STRAIN_ID) ) TABLESPACE DATA2;
