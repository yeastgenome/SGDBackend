...
CONTIG_ID INTEGER,
BUD_ID INTEGER,
NOTE_TYPE VARCHAR2(40) NOT NULL CHECK (NOTE_TYPE IN ('Locus', 'Sequence', 'Contig'')),
DISPLAY_NAME VARCHAR2(500) NOT NULL,
...
CREATE INDEX NOTEANNO_CONTIG_FK_INDEX ON NOTEANNOTATION (CONTIG_ID) TABLESPACE DATA03;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE NOTEANNOTATION
ADD CONSTRAINT NOTEANNO_CONTIG_FK FOREIGN KEY (CONTIG_ID) REFERENCES CONTIG (CONTIG_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE NOTEANNOTATION
