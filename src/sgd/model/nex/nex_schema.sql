...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE BINDINGANNOTATION
ADD CONSTRAINT BINDANNO_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DNASUBSEQUENCE
ADD CONSTRAINT DNASUBSEQ_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES LOCUSDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DNASUBSEQUENCE
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE HISTORYANNOTATION
ADD CONSTRAINT HISTANNO_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ANNOTATION_ID INTEGER NOT NULL,
BUD_ID INTEGER,
MOLECULAR_WEIGHT DECIMAL(9,2) NOT NULL,
PROTEIN_LENGTH NUMBER(5) NOT NULL,
...
OXYGEN NUMBER(4),
CARBON NUMBER(5),
NO_CYS_EXT_COEFF DECIMAL(8,2),
ALL_CYS_EXT_COEFF DECIMAL(8,2),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LOCUSCURATION
ADD CONSTRAINT LOCUSCUR_DBENT_FK FOREIGN KEY (LOCUS_ID) REFERENCES LOCUSDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_LITERATUREANNOTATION
ADD CONSTRAINT ARLITANNO_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX ARCHCONTIG_GENREL_FK_INDEX ON ARCH_CONTIG (GENOMERELEASE_ID) TABLESPACE DATA16;
...
CONSTRAINT ARCH_DNASUBSEQUENCE_UK UNIQUE (DNASEQUENCE_ANNOTATION_ID, SUBCLASS, RELATIVE_START_INDEX, RELATIVE_END_INDEX)) TABLESPACE DATA11;
CREATE INDEX ARCHDNASEQEXT_DBENT_FK_INDEX ON ARCH_DNASUBSEQUENCE (LOCUS_ID) TABLESPACE DATA11;
CREATE INDEX ARCHDNASEQEXT_GENREL_FK_INDEX ON ARCH_DNASUBSEQUENCE (GENOMERELEASE_ID) TABLESPACE DATA11;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASUBSEQUENCE
ADD CONSTRAINT ARCHDNASEQEXT_DBENT_FK FOREIGN KEY (LOCUS_ID) REFERENCES LOCUSDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_DNASUBSEQUENCE
ADD CONSTRAINT ARCHDNASEQEXT_GENREL_FK FOREIGN KEY (GENOMERELEASE_ID) REFERENCES GENOMERELEASE (GENOMERELEASE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
