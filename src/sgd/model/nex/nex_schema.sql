...
CONSTRAINT ARCH_DNASEQANNOTATION_UK UNIQUE (DBENTITY_ID, TAXONOMY_ID, CONTIG_ID, SO_ID, DNA_TYPE) ) TABLESPACE DATA04
LOB (RESIDUES) store as SECUREFILE (TABLESPACE LOB01
enable storage in row CHUNK 8K nocache nologging retention none);
CREATE INDEX ARCHDNASEQANNO_TAX_FK_INDEX ON ARCH_DNASEQANNOTATION (TAXONOMY_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_REF_FK_INDEX ON ARCH_DNASEQANNOTATION (REFERENCE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_SOURCE_FK_INDEX ON ARCH_DNASEQANNOTATION (SOURCE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_CONTIG_FK_INDEX ON ARCH_DNASEQANNOTATION (CONTIG_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_SO_FK_INDEX ON ARCH_DNASEQANNOTATION (SO_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_GENREL_FK_INDEX ON ARCH_DNASEQANNOTATION (GENOMERELEASE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHDNASEQANNO_FILE_FK_INDEX ON ARCH_DNASEQANNOTATION (FILE_ID) TABLESPACE DATA04;
...
LOB (RESIDUES) store as SECUREFILE (TABLESPACE LOB01
enable storage in row CHUNK 8K nocache nologging retention none);
CREATE INDEX ARCHPROTSEQANNO_TAX_FK_INDEX ON ARCH_PROTEINSEQANNOTATION (TAXONOMY_ID) TABLESPACE DATA04;
CREATE INDEX ARCHPROTSEQANNO_REF_FK_INDEX ON ARCH_PROTEINSEQANNOTATION (REFERENCE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHPROTSEQANNO_SOURCE_FK_IDX ON ARCH_PROTEINSEQANNOTATION (SOURCE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHPROTSEQANNO_CONTIG_FK_IDX ON ARCH_PROTEINSEQANNOTATION (CONTIG_ID) TABLESPACE DATA04;
CREATE INDEX ARCHPROTSEQANNO_GENREL_FK_IDX ON ARCH_PROTEINSEQANNOTATION (GENOMERELEASE_ID) TABLESPACE DATA04;
CREATE INDEX ARCHPROTSEQANNO_FILE_FK_INDEX ON ARCH_PROTEINSEQANNOTATION (FILE_ID) TABLESPACE DATA04;
