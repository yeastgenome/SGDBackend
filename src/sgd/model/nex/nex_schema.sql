...
CONSTRAINT DBUSER_UK UNIQUE (USERID) ) TABLESPACE DATA01;
...
CREATE INDEX ARCHCONTIGCHANGE_CONTIG_FK_INDEX ON ARCH_CONTIG_CHANGE (CONTIG_ID) TABLESPACE DATA16;
ALTER TABLE ARCH_CONTIG
ADD CONSTRAINT ARCHCONTIGCHANGE_CONTIG_FK FOREIGN KEY (CONTIG_ID) REFERENCES ARCH_CONTIG (CONTIG_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_CONTIG
ADD CONSTRAINT ARCHCONTIGCHANGE_GENRELEASE_FK FOREIGN KEY (GENOME_RELEASE_ID) REFERENCES GENOME_RELEASE (GENOME_RELEASE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
