...
GO_QUALIFIER VARCHAR2(40) NOT NULL CHECK (QUALIFIER IN ('enables', 'involved in', 'part of', 'NOT', 'colocalizes_with', 'contributes_to')),
...
BUD_ID INTEGER,
GO_ID INTEGER NOT NULL,
SLIM_NAME VARCHAR2(40) NOT NULL,
GENOME_COUNT INTEGER NOT NULL,
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT GOSLIMANNOTATION_PK PRIMARY KEY (ANNOTATION_ID),
CONSTRAINT GOSLIMANNOTATION_UK UNIQUE (LOCUS_ID, GO_ID)) TABLESPACE DATA03;
...
CREATE INDEX GOSLIMANNO_GO_FK_INDEX ON GOSLIMANNOTATION	(GO_ID) TABLESPACE DATA03;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE GOSLIMANNOTATION
ADD CONSTRAINT GOSLIMANNO_GO_FK FOREIGN KEY (GO_ID) REFERENCES GO (GO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
