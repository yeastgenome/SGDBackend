...
CONSTRAINT AUTHOR_UK UNIQUE (FORMAT_NAME, ORCID) ) TABLESPACE DATA02;
...
CONSTRAINT REFERENCE_DELETED_UK UNIQUE (PUBMED_ID)) TABLESPACE DATA02;
CREATE INDEX REFDEL_SGDID_FK_INDEX ON REFERENCE_DELETED (SGDID_ID) TABLESPACE DATA02;
ALTER TABLE REFERENCE_DELETED
ADD CONSTRAINT REFDEL_SGDID_FK FOREIGN KEY (SGDID_ID) REFERENCES SGDID (SGDID_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
BUD_ID INTEGER,
COLLEAGUE_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('Lab','Research summary','Reference supplement')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
COLLELAGUE_ID INTEGER NOT NULL,
ASSOCIATE_ID INTEGER NOT NULL,
ASSOCIATION_TYPE VARCHAR2(40) NOT NULL CHECK (RELATION_TYPE IN ('Associate', 'Lab member')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
CREATE INDEX COLL_ASSOC_SOURCE_FK_INDEX ON COLLEAGUE_RELATION (SOURCE_ID) TABLESPACE DATA02;
CREATE INDEX COLL_ASSOC_ASSOC_FK_INDEX ON COLLEAGUE_RELATION (ASSOCIATE_ID) TABLESPACE DATA02;
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT STRAIN_SUMMARY_REFERENCE_PK PRIMARY KEY (DOCUMENT_REFERENCE_ID),
...
CONSTRAINT ALLELE_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA08;
...
_RELATION TO AUXILIARY;
CONSTRAINT EXPERIMENT_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA03;
...
CONSTRAINT EXPERIMENT_ALIAS_UK UNIQUE (EXPERIMENT_ID, DISPLAY_NAME, ALIAS_TYPE) ) TABLESPACE DATA03;
...
CONSTRAINT GOTERM_URL_UK UNIQUE (GOTERM_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA05;
