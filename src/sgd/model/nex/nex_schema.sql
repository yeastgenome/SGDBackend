...
FORMAT_NAME VARCHAR2(100) NOT NULL, 
DISPLAY_NAME VARCHAR2(500) NOT NULL,
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('ALLELE', 'DOMAIN', 'CHEMICAL', 'ORPHAN', 'CONTIG')),
OBJ_URL VARCHAR2(500), 
SOURCE_ID INTEGER NOT NULL,
...
STRAND VARCHAR2(1),
CONSTRAINT DNASEQUENCEEVIDENCE_PK PRIMARY KEY (EVIDENCE_ID) ) TABLESPACE DATA1;
CREATE INDEX DNASEQEV_BIOENT_FK_INDEX ON DNASEQUENCEEVIDENCE (BIOENTITY_ID) TABLESPACE DATA1;
CREATE INDEX DNASEQEV_CONTIG_FK_INDEX ON DNASEQUENCEEVIDENCE	(CONTIG_ID) TABLESPACE DATA1;
