...
CLASS VARCHAR2(40) NOT NULL CHECK (CLASS IN ('BIOENTITY', 'BIOCONCEPT', 'BIOITEM', 'REFERENCE', 'EXPERIMENT')),
...
FORMAT_NAME VARCHAR2(100) NOT NULL, 
DISPLAY_NAME VARCHAR2(500) NOT NULL,
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('ALLELE', 'DOMAIN', 'CHEMICAL', 'ORPHAN')),
OBJ_URL VARCHAR2(500), 
SOURCE_ID INTEGER NOT NULL,
...
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('LOCUS', 'PROTEIN', 'TRANSCRIPT', 'COMPLEX')),
...
FORMAT_NAME VARCHAR2(100) NOT NULL, 
DISPLAY_NAME VARCHAR2(500) NOT NULL, 
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('CONDITION', 'TEMPERATURE', 'BIOENTITY', 'BIOCONCEPT', 'BIOITEM', 'CHEMICAL')),
EVIDENCE_ID INTEGER NOT NULL, 
ROLE VARCHAR2(40),
NOTE VARCHAR(1000), 
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL, 
...
CLASS VARCHAR(40) NOT NULL CHECK (CLASS IN ('BIOENTITY', 'BIOCONCEPT', 'BIOITEM', 'REFERENCE', 'AUTHOR')),
SUBCLASS VARCHAR(40) CHECK (SUBCLASS IN ('LOCUS', 'PROTEIN', 'COMPLEX', 'GO', 'PHENOTYPE', 'EC_NUMBER', 'DOMAIN', 'CONTIG', 'CHEMICAL')),
