...
DROP TABLE POSTRANSLATIONANNOTATION CASCADE CONSTRAINTS;
CREATE TABLE POSTRANSLATIONANNOTATION (
ANNOTATION_ID INTEGER NOT NULL,
DBENTITY_ID INTEGER NOT NULL,
SOURCE_ID INTEGER NOT NULL,
TAXONOMY_ID INTEGER NOT NULL,
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT POSTRANSLATIONANNOTATION_PK PRIMARY KEY (ANNOTATION_ID),
CONSTRAINT POSTRANSLATIONANNOTATION_UK UNIQUE (DBENTITY_ID, PSIMOD_ID, SITE_RESIDUE, SITE_INDEX, REFERENCE_ID) ) TABLESPACE DATA03;
CREATE INDEX PTRANSANNO_REF_FK_INDEX ON POSTRANSLATIONANNOTATION (REFERENCE_ID) TABLESPACE DATA03;
CREATE INDEX PTRANSANNO_TAX_FK_INDEX ON POSTRANSLATIONANNOTATION (TAXONOMY_ID) TABLESPACE DATA03;
CREATE INDEX PTRANSANNO_SOURCE_FK_INDEX ON POSTRANSLATIONANNOTATION (SOURCE_ID) TABLESPACE DATA03;
CREATE INDEX PTRANSANNO_MOD_FK_INDEX ON POSTRANSLATIONANNOTATION (MODIFIER_ID) TABLESPACE DATA03;
CREATE INDEX PTRANSANNO_PSIMOD_FK_INDEX ON POSTRANSLATIONANNOTATION (PSIMOD_ID) TABLESPACE DATA03;
ALTER TABLE POSTRANSLATIONANNOTATION
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON POSTRANSLATIONANNOTATION TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON POSTRANSLATIONANNOTATION TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON POSTRANSLATIONANNOTATION TO AUXILIARY;
