...
ADD CONSTRAINT ARLITANNO_EV_FK FOREIGN KEY (ANNOTATION_ID) REFERENCES ANNOTATION (ANNOTATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ARCH_LITERATUREANNOTATION
...
ADD CONSTRAINT BINDANNO_EV_FK FOREIGN KEY (ANNOTATION_ID) REFERENCES ANNOTATION (ANNOTATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE BINDINGANNOTATION
...
ADD CONSTRAINT DNASEQANNO_EV_FK FOREIGN KEY (ANNOTATION_ID) REFERENCES ANNOTATION (ANNOTATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DNASEQUENCEANNOTATION
...
CONSTRAINT REGULATIONANNOTATION_UK UNIQUE (DBENTITY1_ID, DBENTITY2_ID, EXPERIMENT_ID, REFERENCE_ID, ORGANISM_ID, CONDITIONS_KEY)) TABLESPACE DATA07;
