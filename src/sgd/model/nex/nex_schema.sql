...
CREATE INDEX ORGANISMDBENTITY_TAXONOMY_FK_INDEX ON ORGANISMDBENTITY (TAXONOMY_ID) TABLESPACE DATA01;
...
EVIDENCE_ID INTEGER NULL,
ORGANISM_ID INTEGER NULL,
HISTORY_TYPE VARCHAR2(100) NULL,
SUBCLASS VARCHAR2(40) NULL,
HISTORY_NOTE VARCHAR2(4000) NULL,
