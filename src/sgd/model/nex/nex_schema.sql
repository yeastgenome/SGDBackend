...
CREATE INDEX GOANNO_ECO_FK_INDEX ON GOANNOTATION (ECO_ID) TABLESPACE DATA05;
...
CONSTRAINT LITERATUREANNOTATION_UK UNIQUE (LOCUS_ID, REFERENCE_ID, TOPIC) ) TABLESPACE DATA04;
CREATE INDEX LITANNO_REF_FK_INDEX ON LITERATUREANNOTATION (REFERENCE_ID) TABLESPACE DATA04;
CREATE INDEX LITANNO_STRAIN_FK_INDEX ON LITERATUREANNOTATION (STRAIN_ID) TABLESPACE DATA04;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LITERATUREANNOTATION
ADD CONSTRAINT LITANNO_STRAIN_FK FOREIGN KEY (STRAIN_ID) REFERENCES STRAINDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LITERATUREANNOTATION
...
CONSTRAINT PHENOTYPEANNOTATION_UK UNIQUE (LOCUS_ID,PHENOTYPE_ID,STRAIN_ID,EXPERIMENT_ID,REFERENCE_ID,MUTANT_ID,ALLELE_ID,REPORTER_ID,CHEBI_ID,ASSAY_ID,ANALYSIS_ID) ) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_SOURCE_FK_INDEX ON PHENOTYPEANNOTATION (SOURCE_ID) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_STRAIN_FK_INDEX ON PHENOTYPEANNOTATION (STRAIN_ID) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_REF_FK_INDEX ON PHENOTYPEANNOTATION (REFERENCE_ID) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_PHENO_FK_INDEX ON PHENOTYPEANNOTATION (PHENOTYPE_ID) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_EXPT_FK_INDEX ON PHENOTYPEANNOTATION (EXPERIMENT_ID) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_MUTANT_FK_INDEX ON PHENOTYPEANNOTATION (MUTANT_ID) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_ALLELE_FK_INDEX ON PHENOTYPEANNOTATION (ALLELE_ID) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_REPORTER_FK_INDEX ON PHENOTYPEANNOTATION (REPORTER_ID) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_CHEBI_FK_INDEX ON PHENOTYPEANNOTATION (CHEBI_ID) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_ASSAY_FK_INDEX ON PHENOTYPEANNOTATION (ASSAY_ID) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_ANAL_FK_INDEX ON PHENOTYPEANNOTATION (ANALYSIS_ID) TABLESPACE DATA04;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE PHENOTYPEANNOTATION
ADD CONSTRAINT PHENOANNO_STRAIN_FK FOREIGN KEY (STRAIN_ID) REFERENCES STRAINDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE PHENOTYPEANNOTATION
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE PHENOTYPEANNOTATION
ADD CONSTRAINT PHENOANNO_CHEBI_FK FOREIGN KEY (CHEBI_ID) REFERENCES CHEBI (CHEBI_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE PHENOTYPEANNOTATION
...
CONSTRAINT PHENOTYPEANNOTATION_DETAIL_UK UNIQUE (ANNOTATION_ID, DETAIL_TYPE, DETAIL_NAME, DETAIL_VALUE) ) TABLESPACE DATA04;
