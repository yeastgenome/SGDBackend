...
DBENTITY_STATUS VARCHAR2(40) CHECK (DBENTITY_STATUS IN ('Active','Merged','Deleted','Archived')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
ALIAS_TYPE VARCHAR2(40) NOT NULL CHECK (ALIAS_TYPE IN ('NCBI protein name','Non-uniform','Retired name','Uniform')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
