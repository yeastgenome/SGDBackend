...
SOURCE_ID INTEGER NOT NULL,
DESCRIPTION VARCHAR2(400),
IS_ALTERNATIVE_REFERENCE INTEGER NOT NULL,
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL, 
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL, 
...
DROP TABLE TRANSCRIPTBIOENTITY CASCADE CONSTRAINTS;
CREATE TABLE TRANSCRIPTBIOENTITY (
BIOENTITY_ID INTEGER NOT NULL,
LOCUS_ID INTEGER NOT NULL,
CONSTRAINT TRANSCRIPTBIOENTITY_PK PRIMARY KEY (BIOENTITY_ID) ) TABLESPACE DATA1;
CREATE INDEX TRANSCBIOENT_LOCUS_FK_INDEX ON TRANSCRIPTBIOENTITY (LOCUS_ID) TABLESPACE DATA1;
ALTER TABLE TRANSCRIPTBIOENTITY
ADD CONSTRAINT TRANSCBIOENT_BIOENT_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES BIOENTITY (BIOENTITY_ID);
ALTER TABLE TRANSCRIPTBIOENTITY
ADD CONSTRAINT TRANSCBIOENT_LOCUS_FK FOREIGN KEY (LOCUS_ID) REFERENCES BIOENTITY (BIOENTITY_ID);
GRANT SELECT ON TRANSCRIPTBIOENTITY TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSCRIPTBIOENTITY TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON TRANSCRIPTBIOENTITY TO AUXILIARY;
...
ALIPHATIC_INDEX DECIMAL(7, 6),
INSTABILITY_INDEX DECIMAL(7, 6),
...
BIOENTITY_ID INTEGER NOT NULL,
BIOCONCEPT_ID INTEGER NOT NULL,
CONSTRAINT ECNUMBEREVIDENCE_PK PRIMARY KEY (EVIDENCE_ID) ) TABLESPACE DATA1;
CREATE INDEX ECEV_BIOENT_FK_INDEX ON ECNUMBEREVIDENCE (BIOENTITY_ID) TABLESPACE DATA1;
CREATE INDEX ECEV_BIOCON_FK_INDEX ON ECNUMBEREVIDENCE	(BIOCONCEPT_ID) TABLESPACE DATA1;
ALTER TABLE ECNUMBEREVIDENCE
ADD CONSTRAINT ECEV_EV_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES EVIDENCE (EVIDENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ECNUMBEREVIDENCE
ADD CONSTRAINT ECEV_BIOENT_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES PROTEINBIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ECNUMBEREVIDENCE
...
CONSTRAINT PROTEINEXPERIMENTEVIDENCE_PK PRIMARY KEY (EVIDENCE_ID) ) TABLESPACE DATA1;
CREATE INDEX PROTEXPEV_BIOENT_FK_INDEX ON PROTEINEXPERIMENTEVIDENCE (BIOENTITY_ID) TABLESPACE DATA1;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE PROTEINEXPERIMENTEVIDENCE
ADD CONSTRAINT PROTEXPEV_BIOENT_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES PROTEINBIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE SEQUENCEEVIDENCE
ADD CONSTRAINT SEQEV_BIOENT_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES BIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE SEQUENCEEVIDENCE
...
DROP TABLE GENDNASEQUENCEEVIDENCE CASCADE CONSTRAINTS;
CREATE TABLE GENDNASEQUENCEEVIDENCE (
EVIDENCE_ID INTEGER NOT NULL,
CONTIG_ID INTEGER NOT NULL,
START_INDEX INTEGER NOT NULL,
END_INDEX INTEGER NOT NULL,
STRAND VARCHAR2(1),
CONSTRAINT GENDNASEQUENCEEVIDENCE_PK PRIMARY KEY (EVIDENCE_ID) ) TABLESPACE DATA1;
CREATE INDEX GENDNASEQEV_CONTIG_FK_INDEX ON GENDNASEQUENCEEVIDENCE	(CONTIG_ID) TABLESPACE DATA1;
ALTER TABLE GENDNASEQUENCEEVIDENCE
ADD CONSTRAINT GENDNASEQEV_EV_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES SEQUENCEEVIDENCE (EVIDENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE GENDNASEQUENCEEVIDENCE
ADD CONSTRAINT GENDNASEQEV_CONTIG_FK FOREIGN KEY (CONTIG_ID) REFERENCES BIOSEQUENCE (BIOSEQUENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON GENDNASEQUENCEEVIDENCE TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON GENDNASEQUENCEEVIDENCE TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON GENDNASEQUENCEEVIDENCE TO AUXILIARY;
