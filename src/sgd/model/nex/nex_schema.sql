...
CONSTRAINT APO_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_ONTOLOGY_ID)) TABLESPACE DATA02;
...
CREATE INDEX APO_REL_RO_FK_INDEX ON APO_RELATION (RELATION_ONTOLOGY_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE APO_RELATION
ADD CONSTRAINT APO_REL_RO_FK FOREIGN KEY (RELATION_ONTOLOGY_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE APO_RELATION
...
CONSTRAINT GO_UK UNIQUE (FORMAT_NAME),
CONSTRAINT GO_GOID_UK UNIQUE (GOID)) TABLESPACE DATA02;
...
CONSTRAINT GO_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_ONTOLOGY_ID)) TABLESPACE DATA02;
...
CREATE INDEX GO_REL_RO_FK_INDEX ON GO_RELATION (RELATION_ONTOLOGY_ID) TABLESPACE DATA02;
