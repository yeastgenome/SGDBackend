...
DBXREF_TYPE VARCHAR2(40) CHECK (DBXREF_TYPE IN ('GEO', 'ArrayExpress', 'Publication'')),
DATE_PUBLIC DATE,
...
BUD_ID INTEGER,
DATASET_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('GEO', 'ArrayExpress', 'Lab website', 'Archive website')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
