...
BUD_ID INTEGER,
CHEMICAL_ID INTEGER NOT NULL,
ALIAS_TYPE VARCHAR2(40) NOT NULL CHECK IN (ALIAS_TYPE ('EXACT', 'RELATED', 'Secondary ChEBI ID')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
DISPLAY_NAME VARCHAR2(500) NOT NULL CHECK IN (DISPLAY_NAME ('ChEBI')),
OBJ_URL VARCHAR2(500) NOT NULL,
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
CHEMICAL_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK IN (URL_TYPE ('External')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
PARENT_ID INTEGER NOT NULL,
CHILD_ID INTEGER NOT NULL,
RELATION_TYPE VARCHAR2(40) NOT NULL CHECK IN (RELATION_TYPE ('is a')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
CREATE INDEX ENZYME_SOURCE_FK_INDEX ON ENZYME (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE ENZYME
...
URL_ID INTEGER NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL CHECK IN (DISPLAY_NAME ('ExPASy','BRENDA')),
OBJ_URL VARCHAR2(500) NOT NULL,
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
ENZYME_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK IN (URL_TYPE ('ExPASy','BRENDA')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
BUD_ID INTEGER,
SEQUENCEFEATURE_ID INTEGER NOT NULL,
ALIAS_TYPE VARCHAR2(40) NOT NULL CHECK IN (ALIAS_TYPE ('BROAD','EXACT','RELATED','NARROW')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
URL_ID INTEGER NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL CHECK IN (DISPLAY_NAME ('MISO','OLS')),
OBJ_URL VARCHAR2(500) NOT NULL,
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
SEQUENCEFEATURE_ID INTEGER NOT NULL,
