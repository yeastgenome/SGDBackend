...
CREATE INDEX STRAIN_PAR_FK_INDEX ON STRAIN (PARAGRAPH_ID) TABLESPACE DATA1;
ALTER TABLE STRAIN
ADD CONSTRAINT STRAIN_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID) 
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE STRAIN
ADD CONSTRAINT STRAIN_PAR_FK FOREIGN KEY (PARAGRAPH_ID) REFERENCES PARAGRAPH (PARAGRAPH_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
