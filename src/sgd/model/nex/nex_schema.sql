...
CONSTRAINT ARCH_CONTIG_UK UNIQUE (FORMAT_NAME, GENOMERELEASE_ID)) TABLESPACE DATA04
LOB (RESIDUES) store as SECUREFILE (TABLESPACE LOB01
enable storage in row CHUNK 8K nocache nologging retention none);
...
CREATE INDEX ARCHPROTSEQANNO_CTG_FK_INDEX ON ARCH_PROTEINSEQANNOTATION (CONTIG_ID) TABLESPACE DATA04;
