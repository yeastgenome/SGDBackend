...
CONSTRAINT PHENOTYPEANNOTATION_UK UNIQUE (LOCUS_ID,PHENOTYPE_ID,TAXONOMY_ID,EXPERIMENT_ID,REFERENCE_ID,MUTANT_ID,ALLELE_ID,REPORTER_ID,CHEBI_ID,ASSAY_ID,ANALYSIS_ID) ) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_SOURCE_FK_INDEX ON PHENOTYPEANNOTATION (SOURCE_ID) TABLESPACE DATA04;
CREATE INDEX PHENOANNO_TAXONOMY_FK_INDEX ON PHENOTYPEANNOTATION (TAXONOMY_ID) TABLESPACE DATA04;
