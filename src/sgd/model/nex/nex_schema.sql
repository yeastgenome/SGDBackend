...
CONSTRAINT EVIDENCE_URL_UK UNIQUE (EVIDENCE_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA03;
...
CONSTRAINT CHEMICAL_ALIAS_UK UNIQUE (CHEMICAL_ID, DISPLAY_NAME, ALIAS_TYPE) ) TABLESPACE DATA03;
...
CONSTRAINT CHEMICAL_URL_UK UNIQUE (CHEMICAL_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA03;
...
CONSTRAINT ENZYME_URL_UK UNIQUE (ENZYME_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA03;
...
EXPERIMENTFACTOR_ID INTEGER NOT NULL,
FORMAT_NAME VARCHAR2(100) NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL,
EFO_ID VARCHAR2(50),
OBJ_URL VARCHAR2(500),
...
CONSTRAINT EXPERIMENTFACTOR_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA03;
...
ALIAS_ID INTEGER NOT NULL,
DISPLAY_NAME VARCHAR2(900) NOT NULL,
OBJ_URL VARCHAR2(500),
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
EXPERIMENTFACTOR_ID INTEGER NOT NULL,
...
CONSTRAINT EXPERIMENTFACTOR_ALIAS_UK UNIQUE (EXPERIMENTFACTOR_ID, DISPLAY_NAME, ALIAS_TYPE) ) TABLESPACE DATA03;
...
CONSTRAINT EXPERIMENTFACTOR_URL_UK UNIQUE (EXPERIMENTFACTOR_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA03;
...
DROP TABLE LOCUSANNOTATION CASCADE CONSTRAINTS;
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT LOCUSANNOTATION_PK PRIMARY KEY (ANNOTATION_ID),
CONSTRAINT LOCUSANNOTATION_UK UNIQUE (DBENTITY_ID, REFERENCE_ID, DATA_TYPE) ) TABLESPACE DATA08;
CREATE INDEX LOCANNO_REF_FK_INDEX ON LOCUSANNOTATION (REFERENCE_ID) TABLESPACE DATA08;
CREATE INDEX LOCANNO_TAX_FK_INDEX ON LOCUSANNOTATION (TAXONOMY_ID) TABLESPACE DATA08;
CREATE INDEX LOCANNO_EV_FK_INDEX ON LOCUSANNOTATION (EVIDENCE_ID) TABLESPACE DATA08;
CREATE INDEX LOCANNO_SOURCE_FK_INDEX ON LOCUSANNOTATION (SOURCE_ID) TABLESPACE DATA08;
ALTER TABLE LOCUSANNOTATION
ADD CONSTRAINT LOCANNO_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LOCUSANNOTATION
ADD CONSTRAINT LOCANNO_TAX_FK FOREIGN KEY (TAXONOMY_ID) REFERENCES TAXONOMY (TAXONOMY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LOCUSANNOTATION
ADD CONSTRAINT LOCANNO_EV_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES EVIDENCE (EVIDENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LOCUSANNOTATION
ADD CONSTRAINT LOCANNO_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LOCUSANNOTATION
ADD CONSTRAINT LOCANNO_DBENTITY_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON LOCUSANNOTATION TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON LOCUSANNOTATION TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON LOCUSANNOTATION TO AUXILIARY;
