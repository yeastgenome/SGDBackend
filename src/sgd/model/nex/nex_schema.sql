...
CREATE INDEX GENOME_RELEASE_SOURCE_FK_INDEX ON GENOME_RELEASE (SOURCE_ID) TABLESPACE DATA01; 
...
SEQ_VERSION DATE,
COORD_VERSION DATE,
GENOME_RELEASE_ID INTEGER NULL,
...
PI DECIMAL(4,2) NULL,
CAI DECIMAL(4,3) NULL,
N_TERM_SEQ VARCHAR2(10) NOT NULL,
C_TERM_SEQ VARCHAR2(10) NOT NULL,
CODON_BIAS DECIMAL(4,3) NULL,
FOP_SCORE DECIMAL(4,3) NULL,
GRAVY_SCORE DECIMAL(7,6) NULL,
AROMATICITY_SCORE DECIMAL(7,6) NULL,
ALIPHATIC_INDEX DECIMAL(3,2) NULL,
INSTABILITY_INDEX DECIMAL(3,2) NULL,
...
CONSTRAINT ARCH_PROTEINSEQUENCEANNOTATION_UK UNIQUE (DBENTITY_ID, ORGANISM_ID, PROTEIN_TYPE) ) TABLESPACE DATA11;
CREATE INDEX ARPROTSEQANNO_REF_FK_INDEX ON ARCH_PROTEINSEQUENCEANNOTATION (REFERENCE_ID) TABLESPACE DATA11;
CREATE INDEX ARPROTSEQANNO_ORGANISM_FK_INDEX ON ARCH_PROTEINSEQUENCEANNOTATION (ORGANISM_ID) TABLESPACE DATA11;
CREATE INDEX ARPROTSEQANNO_EV_FK_INDEX ON ARCH_PROTEINSEQUENCEANNOTATION (EVIDENCE_ID) TABLESPACE DATA11;
CREATE INDEX ARPROTSEQANNO_SOURCE_FK_INDEX ON ARCH_PROTEINSEQUENCEANNOTATION (SOURCE_ID) TABLESPACE DATA11;
CREATE INDEX ARPROTSEQANNO_GENRELEASE_FK_INDEX ON ARCH_PROTEINSEQUENCEANNOTATION (GENOME_RELEASE_ID) TABLESPACE DATA11;
