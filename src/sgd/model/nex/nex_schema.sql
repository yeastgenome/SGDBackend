...
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('LOCUS','FILE','REFERENCE','STRAIN')),
...
CONSTRAINT SGDID_UK UNIQUE (DISPLAY_NAME) ) TABLESPACE DATA01;
...
CREATE TABLE RO (
RELATION_ONTOLOGY_ID INTEGER NOT NULL,
FORMAT_NAME VARCHAR2(100) NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL,
OBJ_URL VARCHAR2(500),
SOURCE_ID INTEGER NOT NULL,
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT RO_PK PRIMARY KEY (RELATION_ONTOLOGY_ID),
...
CONSTRAINT RO_URL_UK UNIQUE (RELATION_ONTOLOGY_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE RO_URL
ADD CONSTRAINT RO_URL_RO_FK FOREIGN KEY (RELATION_ONTOLOGY_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ADD CONSTRAINT RO_REL_CHILD_FK FOREIGN KEY (CHILD_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE RO_RELATION
ADD CONSTRAINT RO_REL_PARENT_FK FOREIGN KEY (PARENT_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE RO_RELATION
...
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
CHEBI_ID VARCHAR2(20),
DESCRIPTION VARCHAR2(2000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT CHEMICAL_PK PRIMARY KEY (CHEMICAL_ID),
CONSTRAINT CHEMICAL_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE INDEX CHEM_SOURCE_FK_INDEX ON CHEMICAL (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT CHEMICAL_ALIAS_UK UNIQUE (CHEMICAL_ID, DISPLAY_NAME, ALIAS_TYPE) ) TABLESPACE DATA02;
CREATE INDEX CHEM_ALIAS_SOURCE_FK_INDEX ON CHEMICAL_ALIAS (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE CHEMICAL_ALIAS
ADD CONSTRAINT CHEM_ALIAS_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE CHEMICAL_ALIAS
ADD CONSTRAINT CHEM_ALIAS_CHEM_FK FOREIGN KEY (CHEMICAL_ID) REFERENCES CHEMICAL (CHEMICAL_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT CHEMICAL_URL_UK UNIQUE (CHEMICAL_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA02;
CREATE INDEX CHEM_URL_SOURCE_FK_INDEX ON CHEMICAL_URL (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE CHEMICAL_URL
ADD CONSTRAINT CHEM_URL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE CHEMICAL_URL
ADD CONSTRAINT CHEM_URL_CHEM_FK FOREIGN KEY (CHEMICAL_ID) REFERENCES CHEMICAL (CHEMICAL_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT CHEMICAL_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_ONTOLOGY_ID)) TABLESPACE DATA02;
CREATE INDEX CHEM_REL_CHILD_FK_INDEX ON CHEMICAL_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX CHEM_REL_SOURCE_FK_INDEX ON CHEMICAL_RELATION (SOURCE_ID) TABLESPACE DATA02;
CREATE INDEX CHEM_REL_RO_FK_INDEX ON CHEMICAL_RELATION (RELATION_ONTOLOGY_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE CHEMICAL_RELATION
ADD CONSTRAINT CHEM_REL_RO_FK FOREIGN KEY (RELATION_ONTOLOGY_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE CHEMICAL_RELATION
...
CONSTRAINT ENZYME_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE INDEX ENZ_SOURCE_FK_INDEX ON ENZYME (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE ENZYME
ADD CONSTRAINT ENZ_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
DROP TABLE ENZYME_ALIAS CASCADE CONSTRAINTS;
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT ENZYME_ALIAS_PK PRIMARY KEY (ALIAS_ID),
CONSTRAINT ENZYME_ALIAS_UK UNIQUE (ENZYME_ID, DISPLAY_NAME, ALIAS_TYPE) ) TABLESPACE DATA02;
CREATE INDEX ENZ_ALIAS_SOURCE_FK_INDEX ON ENZYME_ALIAS (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE ENZYME_ALIAS
ADD CONSTRAINT ENZ_ALIAS_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ENZYME_ALIAS
ADD CONSTRAINT ENZ_ALIAS_ENZ_FK FOREIGN KEY (ENZYME_ID) REFERENCES ENZYME (ENZYME_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON ENZYME_ALIAS TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON ENZYME_ALIAS TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON ENZYME_ALIAS TO AUXILIARY;
...
CONSTRAINT ENZYME_URL_UK UNIQUE (ENZYME_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA02;
CREATE INDEX ENZ_URL_SOURCE_FK_INDEX ON ENZYME_URL (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE ENZYME_URL
ADD CONSTRAINT ENZ_URL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ENZYME_URL
ADD CONSTRAINT ENZ_URL_ENZ_FK FOREIGN KEY (ENZYME_ID) REFERENCES ENZYME (ENZYME_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
ECO_ID VARCHAR2(20) NOT NULL,
DESCRIPTION VARCHAR2(1000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT EVIDENCE_PK PRIMARY KEY (EVIDENCE_ID),
CONSTRAINT EVIDENCE_UK UNIQUE (FORMAT_NAME) ) TABLESPACE DATA02;
CREATE INDEX EV_SOURCE_FK_INDEX ON EVIDENCE (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT EVIDENCE_ALIAS_UK UNIQUE (EVIDENCE_ID, DISPLAY_NAME, ALIAS_TYPE) ) TABLESPACE DATA02;
CREATE INDEX EV_ALIAS_SOURCE_FK_INDEX ON EVIDENCE_ALIAS (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT EVIDENCE_URL_UK UNIQUE (EVIDENCE_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA02;
CREATE INDEX EV_URL_SOURCE_FK_INDEX ON EVIDENCE_URL (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE EVIDENCE_URL
ADD CONSTRAINT EV_URL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE EVIDENCE_URL
ADD CONSTRAINT EV_URL_EV_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES EVIDENCE (EVIDENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT EVIDENCE_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_ONTOLOGY_ID)) TABLESPACE DATA02;
CREATE INDEX EV_REL_CHILD_FK_INDEX ON EVIDENCE_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX EV_REL_RO_FK_INDEX ON EVIDENCE_RELATION (RELATION_ONTOLOGY_ID) TABLESPACE DATA02;
CREATE INDEX EV_REL_SOURCE_FK_INDEX ON EVIDENCE_RELATION (SOURCE_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE EVIDENCE_RELATION
ADD CONSTRAINT EV_REL_RO_FK FOREIGN KEY (RELATION_ONTOLOGY_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE EVIDENCE_RELATION
...
DROP TABLE OBINVESTIGATION CASCADE CONSTRAINTS;
CREATE TABLE OBINVESTIGATION (
OBINVESTIGATION_ID INTEGER NOT NULL,
FORMAT_NAME VARCHAR2(100) NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL,
OBJ_URL VARCHAR2(500),
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
OBI_ID VARCHAR2(20) NOT NULL,
DESCRIPTION VARCHAR2(2000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT OBINVESTIGATION_PK PRIMARY KEY (OBINVESTIGATION_ID),
CONSTRAINT OBINVESTIGATION_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE INDEX OBI_SOURCE_FK_INDEX ON OBINVESTIGATION (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE OBINVESTIGATION
ADD CONSTRAINT OBI_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON OBINVESTIGATION TO DBSELECT;
GRANT INSERT, SELECT, UPDATE ON OBINVESTIGATION TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON OBINVESTIGATION TO AUXILIARY;

DROP TABLE OBINVESTIGATION_URL CASCADE CONSTRAINTS;
CREATE TABLE OBINVESTIGATION_URL (
URL_ID INTEGER NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL CHECK (DISPLAY_NAME IN ('Ontobee')),
OBJ_URL VARCHAR2(500) NOT NULL,
SOURCE_ID INTEGER NOT NULL,
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT OBINVESTIGATION_URL_PK PRIMARY KEY (URL_ID),
CONSTRAINT OBINVESTIGATION_URL_UK UNIQUE (OBINVESTIGATION_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA02;
CREATE INDEX OBI_URL_SOURCE_FK_INDEX ON OBINVESTIGATION_URL (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE OBINVESTIGATION_URL
ADD CONSTRAINT OBI_URL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE OBINVESTIGATION_URL
ADD CONSTRAINT OBI_URL_OBI_FK FOREIGN KEY (OBINVESTIGATION_ID) REFERENCES OBINVESTIGATION (OBINVESTIGATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON OBINVESTIGATION_URL TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON OBINVESTIGATION_URL TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON OBINVESTIGATION_URL TO AUXILIARY;

DROP TABLE OBINVESTIGATION_RELATION CASCADE CONSTRAINTS;
CREATE TABLE OBINVESTIGATION_RELATION (
RELATION_ID INTEGER NOT NULL,
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
PARENT_ID INTEGER NOT NULL,
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT OBINVESTIGATION_RELATION_PK PRIMARY KEY (RELATION_ID),
CONSTRAINT OBINVESTIGATION_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_ONTOLOGY_ID)) TABLESPACE DATA02;
CREATE INDEX OBI_REL_CHILD_FK_INDEX ON OBINVESTIGATION_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX OBI_REL_RO_FK_INDEX ON OBINVESTIGATION_RELATION (RELATION_ONTOLOGY_ID) TABLESPACE DATA02;
CREATE INDEX OBI_REL_SOURCE_FK_INDEX ON OBINVESTIGATION_RELATION (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE OBINVESTIGATION_RELATION
ADD CONSTRAINT OBI_REL_CHILD_FK FOREIGN KEY (CHILD_ID) REFERENCES OBINVESTIGATION (OBINVESTIGATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE OBINVESTIGATION_RELATION
ADD CONSTRAINT OBI_REL_PARENT_FK FOREIGN KEY (PARENT_ID) REFERENCES OBINVESTIGATION (OBINVESTIGATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE OBINVESTIGATION_RELATION
ADD CONSTRAINT OBI_REL_RO_FK FOREIGN KEY (RELATION_ONTOLOGY_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE OBINVESTIGATION_RELATION
ADD CONSTRAINT OBI_REL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON OBINVESTIGATION_RELATION TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON OBINVESTIGATION_RELATION TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON OBINVESTIGATION_RELATION TO AUXILIARY;
...
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER NULL,
SO_ID VARCHAR2(20) NOT NULL,
DESCRIPTION VARCHAR2(2000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT SEQUENCEFEATURE_PK PRIMARY KEY (SEQUENCEFEATURE_ID),
CONSTRAINT SEQUENCEFEATURE_UK UNIQUE (FORMAT_NAME) ) TABLESPACE DATA02;
CREATE INDEX SEQFEAT_SOURCE_FK_INDEX ON SEQUENCEFEATURE (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT SEQUENCEFEATURE_ALIAS_UK UNIQUE (SEQUENCEFEATURE_ID, DISPLAY_NAME, ALIAS_TYPE) ) TABLESPACE DATA02;
CREATE INDEX SEQFEAT_ALIAS_SOURCE_FK_INDEX ON SEQUENCEFEATURE_ALIAS (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE SEQUENCEFEATURE_ALIAS
ADD CONSTRAINT SEQFEAT_ALIAS_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE SEQUENCEFEATURE_ALIAS
ADD CONSTRAINT SEQFEAT_ALIAS_SEQFEAT_FK FOREIGN KEY (SEQUENCEFEATURE_ID) REFERENCES SEQUENCEFEATURE (SEQUENCEFEATURE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT SEQUENCEFEATURE_URL_UK UNIQUE (SEQUENCEFEATURE_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA02;
CREATE INDEX SEQFEAT_URL_SOURCE_FK_INDEX ON SEQUENCEFEATURE_URL (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE SEQUENCEFEATURE_URL
ADD CONSTRAINT SEQFEAT_URL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE SEQUENCEFEATURE_URL
ADD CONSTRAINT SEQFEAT_URL_SEQFEAT_FK FOREIGN KEY (SEQUENCEFEATURE_ID) REFERENCES SEQUENCEFEATURE (SEQUENCEFEATURE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT SEQUENCEFEATURE_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_ONTOLOGY_ID)) TABLESPACE DATA02;
CREATE INDEX SEQFEAT_REL_CHILD_FK_INDEX ON SEQUENCEFEATURE_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX SEQFEAT_REL_RO_FK_INDEX ON SEQUENCEFEATURE_RELATION (RELATION_ONTOLOGY_ID) TABLESPACE DATA02;
CREATE INDEX SEQFEAT_REL_SOURCE_FK_INDEX ON SEQUENCEFEATURE_RELATION (SOURCE_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE SEQUENCEFEATURE_RELATION
ADD CONSTRAINT SEQFEAT_REL_RO_FK FOREIGN KEY (RELATION_ONTOLOGY_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE SEQUENCEFEATURE_RELATION
...
CONSTRAINT TAXONOMY_RELATION_UK UNIQUE (PARENT_ID, CHILD_ID, RELATION_ONTOLOGY_ID)) TABLESPACE DATA02;
CREATE INDEX TAX_REL_CHILD_FK_INDEX ON TAXONOMY_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX TAX_REL_RO_FK_INDEX ON TAXONOMY_RELATION (RELATION_ONTOLOGY_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE TAXONOMY_RELATION
ADD CONSTRAINT TAX_REL_RO_FK FOREIGN KEY (RELATION_ONTOLOGY_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE TAXONOMY_RELATION
...
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('DBENTITY','FILE','LOCUS','REFERENCE','STRAIN')),
...
CREATE INDEX LOCUS_SEQUENCEFEATURE_FK_INDEX ON LOCUSDBENTITY (SEQUENCEFEATURE_ID) TABLESPACE DATA02;
ALTER TABLE LOCUSDBENTITY
ADD CONSTRAINT LOCUS_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LOCUSDBENTITY
ADD CONSTRAINT LOCUS_SEQUENCEFEATURE_FK FOREIGN KEY (SEQUENCEFEATURE_ID) REFERENCES SEQUENCEFEATURE (SEQUENCEFEATURE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
BUD_ID INTEGER,
LOCUS_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('External id','CGI','SGDID','Systematic name')),
...
CONSTRAINT LOCUS_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_ONTOLOGY_ID)) TABLESPACE DATA02;
CREATE INDEX LOCUS_REL_CHILD_FK_INDEX ON LOCUS_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX LOCUS_REL_RO_FK_INDEX ON LOCUS_RELATION (RELATION_ONTOLOGY_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LOCUS_RELATION
ADD CONSTRAINT LOCUS_REL_RO_FK FOREIGN KEY (RELATION_ONTOLOGY_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LOCUS_RELATION
...
CREATE INDEX STRAINDBENTITY_TAX_FK_INDEX ON STRAINDBENTITY (TAXONOMY_ID) TABLESPACE DATA02;
ALTER TABLE STRAINDBENTITY
ADD CONSTRAINT STRAINDBENTITY_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE STRAINDBENTITY
ADD CONSTRAINT STRAINDBENTITY_TAX_FK FOREIGN KEY (TAXONOMY_ID) REFERENCES TAXONOMY (TAXONOMY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE UNIQUE INDEX REF_PUBMED_ID_INDEX ON REFERENCEDBENTITY (PUBMED_ID) TABLESPACE DATA02;
CREATE UNIQUE INDEX REF_PUBMED_CENTRAL_ID_INDEX ON REFERENCEDBENTITY (PUBMED_CENTRAL_ID) TABLESPACE DATA02;
...
CONSTRAINT REFERENCE_REFTYPE_UK UNIQUE (REFERENCE_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA02;
...
CONSTRAINT AUTHOR_UK UNIQUE (FORMAT_NAME) ) TABLESPACE DATA02;
CREATE INDEX AUTHOR_SOURCE_FK_INDEX ON AUTHOR (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE AUTHOR
...
CONSTRAINT REFERENCE_AUTHOR_UK UNIQUE (REFERENCE_ID, AUTHOR_ID, AUTHOR_ORDER) ) TABLESPACE DATA02;
CREATE INDEX REFAUTH_AUTHOR_FK_INDEX ON REFERENCE_AUTHOR (AUTHOR_ID) TABLESPACE DATA02;
CREATE INDEX REFAUTH_SOURCE_FK_INDEX ON REFERENCE_AUTHOR (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE REFERENCE_AUTHOR
ADD CONSTRAINT REFAUTH_AUTHOR_FK FOREIGN KEY (AUTHOR_ID) REFERENCES AUTHOR (AUTHOR_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE REFERENCE_AUTHOR
...
CONSTRAINT REFERENCE_UNLINK_UK UNIQUE (REFERENCE_ID, LOCUS_ID) ) TABLESPACE DATA02;
CREATE INDEX REFUNLINK_LOCUS_FK_INDEX ON REFERENCE_UNLINK (LOCUS_ID) TABLESPACE DATA02;
...
CONSTRAINT REFERENCE_DELETED_PUBMED_UK UNIQUE (PUBMED_ID),
...
FILE_VERSION VARCHAR2(40) NOT NULL,
FILE_EXTENSION VARCHAR2(20) NOT NULL,
FILE_CATEGORY VARCHAR2(40) NOT NULL,
FILE_OUTPUT_TYPE VARCHAR2(40) NOT NULL,
REFERENCE_ID INTEGER,
TAXONOMY_ID INTEGER,
CONSTRAINT FILEDBENTITY_PK PRIMARY KEY (DBENTITY_ID),
CONSTRAINT FILEDBENTITY_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE INDEX FILE_REF_FK_INDEX ON FILEDBENTITY (REFERENCE_ID) TABLESPACE DATA02;
CREATE INDEX FILE_TAX_FK_INDEX ON FILEDBENTITY (TAXONOMY_ID) TABLESPACE DATA02;
ALTER TABLE FILEDBENTITY
ADD CONSTRAINT FILEDBENTITY_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID);
ALTER TABLE FILEDBENTITY
ADD CONSTRAINT FILE_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCEDBENTITY (DBENTITY_ID)
ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE FILEDBENTITY
...
CONSTRAINT FILE_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_ONTOLOGY_ID)) TABLESPACE DATA02;
CREATE INDEX FILE_REL_CHILD_FK_INDEX ON FILE_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX FILE_REL_RO_FK_INDEX ON FILE_RELATION (RELATION_ONTOLOGY_ID) TABLESPACE DATA02;
CREATE INDEX FILE_REL_SOURCE_FK_INDEX ON FILE_RELATION (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE FILE_RELATION
ADD CONSTRAINT FILE_REL_CHILD_FK FOREIGN KEY (CHILD_ID) REFERENCES FILEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE FILE_RELATION
ADD CONSTRAINT FILE_REL_PARENT_FK FOREIGN KEY (PARENT_ID) REFERENCES FILEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE FILE_RELATION
ADD CONSTRAINT FILE_REL_RO_FK FOREIGN KEY (RELATION_ONTOLOGY_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE FILE_RELATION
...
CONSTRAINT COLLEAGUE_UK UNIQUE (FORMAT_NAME),
CONSTRAINT COLLEAGUE_ORCID_UK UNIQUE (ORCID)) TABLESPACE DATA02;
...
CONSTRAINT COLLEAGUE_URL_UK UNIQUE (COLLEAGUE_ID, DISPLAY_NAME, URL_TYPE) ) TABLESPACE DATA02;
...
ASSOCIATION_TYPE VARCHAR2(40) NOT NULL CHECK (ASSOCIATION_TYPE IN ('Associate', 'Lab member')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
CONSTRAINT GOTERM_GOID_UK UNIQUE (GO_ID)) TABLESPACE DATA02;
CREATE INDEX GOTERM_GO_INDEX ON GOTERM (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE GOTERM
...
CONSTRAINT GOTERM_ALIAS_UK UNIQUE (GOTERM_ID, DISPLAY_NAME, ALIAS_TYPE) TABLESPACE DATA02;
CREATE INDEX GOTERM_ALIAS_SOURCE_FK_INDEX ON GOTERM_ALIAS (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT GOTERM_URL_UK UNIQUE (GOTERM_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA02;
CREATE INDEX GOTERM_URL_SOURCE_FK_INDEX ON GOTERM_URL (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE GOTERM_URL
ADD CONSTRAINT GOTERM_URL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE GOTERM_URL
ADD CONSTRAINT GOTERM_URL_GOTERM_FK FOREIGN KEY (GOTERM_ID) REFERENCES GOTERM (GOTERM_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT GOTERM_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_ONTOLOGY_ID)) TABLESPACE DATA02;
CREATE INDEX GO_REL_CHILD_FK_INDEX ON GOTERM_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX GO_REL_SOURCE_FK_INDEX ON GOTERM_RELATION (SOURCE_ID) TABLESPACE DATA02;
CREATE INDEX GO_REL_RO_FK_INDEX ON GOTERM_RELATION (RELATION_ONTOLOGY_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE EVIDENCE_RELATION
ADD CONSTRAINT GO_REL_RO_FK FOREIGN KEY (RELATION_ONTOLOGY_ID) REFERENCES RO (RELATION_ONTOLOGY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX PHENOTYPE_SOURCE_FK_INDEX ON PHENOTYPE (SOURCE_ID) TABLESPACE DATA02;
CREATE INDEX PHENOTYPE_OBSERVABLE_FK_INDEX ON PHENOTYPE (OBSERVABLE_ID) TABLESPACE DATA02;
CREATE INDEX PHENOTYPE_QUALIFIER_FK_INDEX ON PHENOTYPE (QUALIFIER_ID) TABLESPACE DATA02;
...
CONSTRAINT EXPERIMENT_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE INDEX EXP_SOURCE_FK_INDEX ON EXPERIMENT (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT EXPERIMENT_ALIAS_UK UNIQUE (EXPERIMENT_ID, DISPLAY_NAME, ALIAS_TYPE) ) TABLESPACE DATA02;
CREATE INDEX EXP_ALIAS_SOURCE_FK_INDEX ON EXPERIMENT_ALIAS (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT EXPERIMENT_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_TYPE)) TABLESPACE DATA02;
CREATE INDEX EXP_REL_CHILD_FK_INDEX ON EXPERIMENT_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX EXP_REL_SOURCE_FK_INDEX ON EXPERIMENT_RELATION (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT MUTANT_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE INDEX MUTANT_SOURCE_INDEX ON MUTANT (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE MUTANT
...
CONSTRAINT MUTANT_ALIAS_BUD_UK UNIQUE (BUD_ID)) TABLESPACE DATA02;
CREATE INDEX MUT_ALIAS_SOURCE_FK_INDEX ON MUTANT_ALIAS (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT MUTANT_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_TYPE)) TABLESPACE DATA02;
CREATE INDEX MUT_REL_CHILD_FK_INDEX ON MUTANT_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX MUT_REL_SOURCE_FK_INDEX ON MUTANT_RELATION (SOURCE_ID) TABLESPACE DATA02;
...
BUD_ID INTEGER,
APO_ID VARCHAR2(40),
OBSERVABLE_TYPE VARCHAR(40),
DESCRIPTION VARCHAR2(1000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT OBSERVABLE_PK PRIMARY KEY (OBSERVABLE_ID),
CONSTRAINT OBSERVABLE_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE INDEX OBSERVABLE_SOURCE_FK_INDEX ON OBSERVABLE (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT OBSERVABLE_ALIAS_UK UNIQUE (OBSERVABLE_ID, DISPLAY_NAME, ALIAS_TYPE)) TABLESPACE DATA02;
CREATE INDEX OBS_ALIAS_SOURCE_FK_INDEX ON OBSERVABLE_ALIAS (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT OBSERVABLE_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_TYPE)) TABLESPACE DATA02;
CREATE INDEX OBS_REL_CHILD_FK_INDEX ON OBSERVABLE_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX OBS_REL_SOURCE_FK_INDEX ON OBSERVABLE_RELATION (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT QUALIFIER_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE INDEX QUALIFIER_SOURCE_INDEX ON QUALIFIER (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT QUALIFIER_ALIAS_UK UNIQUE (QUALIFIER_ID, DISPLAY_NAME, ALIAS_TYPE)) TABLESPACE DATA02;
CREATE INDEX QUAL_ALIAS_SOURCE_FK_INDEX ON QUALIFIER_ALIAS (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT QUALIFIER_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RELATION_TYPE)) TABLESPACE DATA02;
CREATE INDEX QUAL_REL_CHILD_FK_INDEX ON QUALIFIER_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX QUAL_REL_SOURCE_FK_INDEX ON QUALIFIER_RELATION (SOURCE_ID) TABLESPACE DATA02;
...
CONSTRAINT GENOMERELEASE_UK UNIQUE (FORMAT_NAME),
...
CONSTRAINT PHENOTYPEANNOTATION_UK UNIQUE (DBENTITY_ID, PHENOTYPE_ID, TAXONOMY_ID, EXPERIMENT_ID, REFERENCE_ID, EXPERIMENT_DETAILS, MUTANT_TYPE, CONDITIONS_KEY) ) TABLESPACE DATA06;
