...
FILE_EXTENSION VARCHAR2(10) NOT NULL CHECK (FILE_EXTENSION IN ('gff3', 'bw', 'vcf', 'bam')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
CREATE INDEX DSETTRACK_FORMAT_FK_INDEX ON DATASETTRACK (FILE_FORMAT_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASETTRACK
ADD CONSTRAINT DSETTRACK_FORMAT_FK FOREIGN KEY (FILE_FORMAT_ID) REFERENCES EDAM (EDAM_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
