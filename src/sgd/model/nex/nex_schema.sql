...
DROP TABLE PHENOTYPE_CONDITION CASCADE CONSTRAINTS;
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT PHENOTYPE_CONDITION_PK PRIMARY KEY (CONDITION_ID),
CONSTRAINT PHENOTYPE_CONDITION_UK UNIQUE (ANNOTATION_ID, CONDITION_NAME, CONDITION_VALUE) ) TABLESPACE DATA04;
ALTER TABLE PHENOTYPE_CONDITION
ADD CONSTRAINT PHENOCOND_ANNO_FK FOREIGN KEY (ANNOTATION_ID) REFERENCES PHENOTYPEANNOTATION (ANNOTATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON PHENOTYPE_CONDITION TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON PHENOTYPE_CONDITION TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON PHENOTYPE_CONDITION TO AUXILIARY;
