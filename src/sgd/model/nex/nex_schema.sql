...
DROP TABLE PHENOTYPECONDITION CASCADE CONSTRAINTS;
CREATE TABLE PHENOTYPE_CONDITION (
PHENOTYPECONDITION_ID INTEGER NOT NULL,
ANNOTATION_ID INTEGER NOT NULL,
CONDITION_NAME VARCHAR2(40) NOT NULL,
CONDITION_VALUE VARCHAR2(500) NOT NULL,
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT PHENOTYPECONDITION_PK PRIMARY KEY (PHENOTYPECONDITION_ID),
CONSTRAINT PHENOTYPECONDITION_UK UNIQUE (ANNOTATION_ID, CONDITION_NAME, CONDITION_VALUE) ) TABLESPACE DATA04;
ALTER TABLE PHENOTYPECONDITION
ADD CONSTRAINT PHENOCOND_ANNO_FK FOREIGN KEY (ANNOTATION_ID) REFERENCES PHENOTYPEANNOTATION (ANNOTATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON PHENOTYPECONDITION TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON PHENOTYPECONDITION TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON PHENOTYPECONDITION TO AUXILIARY;
