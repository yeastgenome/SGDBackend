...
CONSTRAINT TAG_UK UNIQUE (FORMAT_NAME) ) TABLESPACE DATA03;
CREATE INDEX TAG_SOURCE_FK ON TAG (SOURCE_ID) TABLESPACE DATA03;
ALTER TABLE TAG
...
CONSTRAINT COLLEAGUE_DBENTITY_UK UNIQUE (COLLEAGUE_ID, DBENTITY_ID, SOURCE_ID) ) TABLESPACE DATA04;
CREATE INDEX COLL_DBENTITY_DBENT_FK_INDEX ON COLLEAGUE_DBENTITY (DBENTITY_ID) TABLESPACE DATA04;
CREATE INDEX COLL_DBENTITY_SOURCE_FK_INDEX ON COLLEAGUE_DBENTITY (SOURCE_ID) TABLESPACE DATA04;
...
CONSTRAINT ORGANISM_UK UNIQUE (FORMAT_NAME) ) TABLESPACE DATA01;
CREATE INDEX ORGANISM_SOURCE_FK_INDEX ON ORGANISM (SOURCE_ID) TABLESPACE DATA01;
...
CREATE INDEX STRAIN_ORGANISM_FK_INDEX ON STRAINDBENTITY (ORGANISM_ID) TABLESPACE DATA01;
...
CREATE INDEX STRAIN_URL_STRAIN_FK_INDEX ON STRAIN_URL (STRAIN_ID) TABLESPACE DATA01;
...
CONSTRAINT DATASET_TAG_UK UNIQUE (TAG_ID, DATASET_ID)) TABLESPACE DATA12;
CREATE INDEX DATASET_TAG_DATASET_FK_INDEX ON DATASET_TAG (DATASET_ID) TABLESPACE DATA12;
...
CREATE INDEX ARLITEV_STRAIN_FK_INDEX ON ARCH_LITERATUREANNOTATION (STRAIN_ID) TABLESPACE DATA04;
...
CREATE INDEX BINDEV_STRAIN_FK_INDEX ON BINDINGANNOTATION (STRAIN_ID) TABLESPACE DATA08;
...
CONSTRAINT DNASEQUENCEANNOTATION_UK UNIQUE (DBENTITY_ID, STRAIN_ID, DNA_TYPE) ) TABLESPACE DATA11;
CREATE INDEX DNASEQEV_REF_FK_INDEX ON DNASEQUENCEANNOTATION (REFERENCE_ID) TABLESPACE DATA11;
CREATE INDEX DNASEQEV_STRAIN_FK_INDEX ON DNASEQUENCEANNOTATION (STRAIN_ID) TABLESPACE DATA11;
...
CONSTRAINT DOMAINANNOTATION_UK UNIQUE (DBENTITY_ID, BIOITEM_ID, START_INDEX, END_INDEX) ) TABLESPACE DATA08;
CREATE INDEX DOMAINEV_REF_FK_INDEX ON DOMAINANNOTATION (REFERENCE_ID) TABLESPACE DATA08;
CREATE INDEX DOMAINEV_STRAIN_FK_INDEX ON DOMAINANNOTATION (STRAIN_ID) TABLESPACE DATA08;
CREATE INDEX DOMAINEV_EXPT_FK_INDEX ON DOMAINANNOTATION (EXPERIMENT_ID) TABLESPACE DATA08;
CREATE INDEX DOMAINEV_SOURCE_FK_INDEX ON DOMAINANNOTATION (SOURCE_ID) TABLESPACE DATA08;
CREATE INDEX DOMAINEV_DBENT_FK_INDEX ON DOMAINANNOTATION (DBENTITY_ID) TABLESPACE DATA08;
CREATE INDEX DOMAINEV_DOMAIN_FK_INDEX ON DOMAINANNOTATION (BIOITEM_ID) TABLESPACE DATA08;
...
CONSTRAINT ENZYMEANNOTATION_UK UNIQUE (DBENTITY_ID, BIOCONCEPT_ID) ) TABLESPACE DATA08;
CREATE INDEX ECEV_REF_FK_INDEX ON ENZYMEANNOTATION (REFERENCE_ID) TABLESPACE DATA08;
CREATE INDEX ECEV_STRAIN_FK_INDEX ON ENZYMEANNOTATION (STRAIN_ID) TABLESPACE DATA08;
...
CREATE INDEX ECEV_BIOCON_FK_INDEX ON ENZYMEANNOTATION	(BIOCONCEPT_ID) TABLESPACE DATA08;
...
CREATE INDEX EXPEV_STRAIN_FK_INDEX ON EXPRESSIONANNOTATION (STRAIN_ID) TABLESPACE DATA12;
...
CREATE INDEX GENINTEV_STRAIN_FK_INDEX ON GENINTERACTIONANNOTATION (STRAIN_ID) TABLESPACE DATA07;
...
CONSTRAINT GOANNOTATION_UK UNIQUE (DBENTITY_ID, BIOCONCEPT_ID, GO_ANNOTATION, REFERENCE_ID, CONDITIONS_KEY)) TABLESPACE DATA05;
CREATE INDEX GOEV_REF_FK_INDEX ON GOANNOTATION (REFERENCE_ID) TABLESPACE DATA05;
CREATE INDEX GOEV_STRAIN_FK_INDEX ON GOANNOTATION (STRAIN_ID) TABLESPACE DATA05;
...
CREATE INDEX GOEV_BIOCON_FK_INDEX ON GOANNOTATION	(BIOCONCEPT_ID) TABLESPACE DATA05;
...
CONSTRAINT GOSLIMANNOTATION_UK UNIQUE (DBENTITY_ID, BIOCONCEPT_ID)) TABLESPACE DATA05;
CREATE INDEX GOSLIMEV_REF_FK_INDEX ON GOSLIMANNOTATION (REFERENCE_ID) TABLESPACE DATA05;
CREATE INDEX GOSLIMEV_STRAIN_FK_INDEX ON GOSLIMANNOTATION (STRAIN_ID) TABLESPACE DATA05;
...
CREATE INDEX GOSLIMEV_BIOCON_FK_INDEX ON GOSLIMANNOTATION	(BIOCONCEPT_ID) TABLESPACE DATA05;
...
CREATE INDEX HISTEV_STRAIN_FK_INDEX ON HISTORYANNOTATION (STRAIN_ID) TABLESPACE DATA01;
...
CREATE INDEX LITEV_STRAIN_FK_INDEX ON LITERATUREANNOTATION (STRAIN_ID) TABLESPACE DATA04;
...
CONSTRAINT PATHWAYANNOTATION_UK UNIQUE (DBENTITY_ID, BIOITEM_ID) ) TABLESPACE DATA07;
CREATE INDEX PATHEV_REF_FK_INDEX ON PATHWAYANNOTATION (REFERENCE_ID) TABLESPACE DATA07;
CREATE INDEX PATHEV_STRAIN_FK_INDEX ON PATHWAYANNOTATION (STRAIN_ID) TABLESPACE DATA07;
...
CREATE INDEX PATHEV_PATH_FK_INDEX ON PATHWAYANNOTATION (BIOITEM_ID) TABLESPACE DATA07;
...
CONSTRAINT PHENOTYPEANNOTATION_UK UNIQUE (DBENTITY_ID, BIOCONCEPT_ID, STRAIN_ID, EXPERIMENT_ID, REFERENCE_ID, EXPERIMENT_DETAILS, MUTANT_TYPE, CONDITIONS_KEY) ) TABLESPACE DATA06;
CREATE INDEX PHENOEV_REF_FK_INDEX ON PHENOTYPEANNOTATION (REFERENCE_ID) TABLESPACE DATA06;
CREATE INDEX PHENOEV_STRAIN_FK_INDEX ON PHENOTYPEANNOTATION (STRAIN_ID) TABLESPACE DATA06;
...
CREATE INDEX PHENOEV_BIOCON_FK_INDEX ON PHENOTYPEANNOTATION (BIOCONCEPT_ID) TABLESPACE DATA06;
...
CREATE INDEX PHOSEV_STRAIN_FK_INDEX ON PHOSPHORYLATIONANNOTATION (STRAIN_ID) TABLESPACE DATA08;
...
CREATE INDEX PHYSINTEV_STRAIN_FK_INDEX ON PHYSINTERACTIONANNOTATION (STRAIN_ID) TABLESPACE DATA07;
...
CREATE INDEX PROTEXPEV_STRAIN_FK_INDEX ON PROTEINEXPERIMENTANNOTATION (STRAIN_ID) TABLESPACE DATA08;
...
CONSTRAINT PROTEINSEQUENCEANNOTATION_UK UNIQUE (DBENTITY_ID, STRAIN_ID, PROTEIN_TYPE) ) TABLESPACE DATA11;
CREATE INDEX PROTSEQEV_REF_FK_INDEX ON PROTEINSEQUENCEANNOTATION (REFERENCE_ID) TABLESPACE DATA11;
CREATE INDEX PROTSEQEV_STRAIN_FK_INDEX ON PROTEINSEQUENCEANNOTATION (STRAIN_ID) TABLESPACE DATA11;
...
CONSTRAINT REGULATIONANNOTATION_UK UNIQUE (DBENTITY_ID, DBENTITY2_ID, EXPERIMENT_ID, REFERENCE_ID, STRAIN_ID, CONDITIONS_KEY)) TABLESPACE DATA07;
CREATE INDEX REGEV_REF_FK_INDEX ON REGULATIONANNOTATION (REFERENCE_ID) TABLESPACE DATA07;
CREATE INDEX REGEV_STRAIN_FK_INDEX ON REGULATIONANNOTATION (STRAIN_ID) TABLESPACE DATA07;
...
CONSTRAINT DBENTITYDATA_UK UNIQUE (ANNOTATION_ID, DBENTITY_ID)) TABLESPACE DATA15;
CREATE INDEX DAT_DBENT_FK_INDEX ON DBENTITYDATA (DBENTITY_ID) TABLESPACE DATA15;
CREATE INDEX DAT_EV_FK_INDEX ON DBENTITYDATA (ANNOTATION_ID) TABLESPACE DATA15;
...
CONSTRAINT DNASEQUENCETAG_UK UNIQUE (ANNOTATION_ID, SUBCLASS, RELATIVE_START_INDEX, RELATIVE_END_INDEX)) TABLESPACE DATA11;
CREATE INDEX DNASEQTAG_EV_FK_INDEX ON DNASEQUENCETAG (ANNOTATION_ID) TABLESPACE DATA11;
CREATE INDEX DNASEQTAG_DBENT_FK_INDEX ON DNASEQUENCETAG (DBENTITY_ID) TABLESPACE DATA11;
...
CONSTRAINT CONDITION_UK UNIQUE (ANNOTATION_ID, FORMAT_NAME, SUBCLASS, ROLE) ) TABLESPACE DATA06;
...
DBENTITY_ID INTEGER NOT NULL, 
CONSTRAINT ANNOTATIONEXTRACONDITION_PK PRIMARY KEY (ANNOTATIONEXTRA_ID) ) TABLESPACE DATA06;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
CREATE INDEX DBENTITYCOND_DBENT_FK_INDEX ON DBENTITYCONDITION (DBENTITY_ID) TABLESPACE DATA06;
...
CONDITION_ID INTEGER NOT NULL,
AMOUNT VARCHAR2(500),
CONSTRAINT CHEMICALCONDITION_PK PRIMARY KEY (CONDITION_ID) ) TABLESPACE DATA06;
...
CONSTRAINT DISAMBIG_UK UNIQUE (DISAMBIG_KEY, CLASS) ) TABLESPACE DATA16;
CREATE INDEX DISAMBIG_OBJID_INDEX ON DISAMBIG (OBJ_ID) TABLESPACE DATA16;
...
CONSTRAINT LOCUSTABS_PK PRIMARY KEY (DBENTITY_ID) ) TABLESPACE DATA16;
