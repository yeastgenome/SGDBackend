...
FORMAT_NAME VARCHAR2(100) NOT NULL, 
DISPLAY_NAME VARCHAR2(500) NOT NULL, 
OBJ_URL VARCHAR2(500), SOURCE_ID INTEGER NOT NULL,
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL, 
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL, 
CONSTRAINT COUNTRY_PK PRIMARY KEY (COUNTRY_ID), 
CONSTRAINT COUNTRY_UK UNIQUE (FORMAT_NAME) TABLESPACE DATA01;
CREATE INDEX COUNTRY_SOURCE_FK_INDEX ON COUNTRY (SOURCE_ID) TABLESPACE DATA01; 
ALTER TABLE COUNTRY ADD CONSTRAINT COUNTRY_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID) 
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE; 
GRANT SELECT ON COUNTRY TO DBSELECT; 
GRANT DELETE, INSERT, SELECT, UPDATE ON COUNTRY TO
CURATOR; GRANT DELETE, INSERT, SELECT, UPDATE ON COUNTRY TO AUXILIARY;
...
OBJ_URL VARCHAR2(500), 
SOURCE_ID INTEGER NOT NULL,
COUNTRY_NAME VARCHAR2(40) CHECK (COUNTRY_NAME IN (‘Canada’, ‘USA’)),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL, 
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL, 
CONSTRAINT STATE_PK PRIMARY KEY (STATE_ID), 
CONSTRAINT STATE_UK UNIQUE (FORMAT_NAME) TABLESPACE DATA01;
CREATE INDEX STATE_SOURCE_FK_INDEX ON STATE (SOURCE_ID) TABLESPACE DATA01; 
ALTER TABLE STATE ADD CONSTRAINT STATE_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID) 
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
OLD_VALUE VARCHAR2(CLOB),
NEW_VALUE VARCHAR2(CLOB),
...
DELETE_LOG_NO INTEGER NOT NULL,
TAB_NAME VARCHAR2(30) NOT NULL,
PRIMARY_KEY INTEGER NOT NULL,
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
DELETED_ROW VARCHAR2(CLOB) NOT NULL,
...
CREATE INDEX EV_SOURCE_FK_INDEX ON INVESTIGATION (SOURCE_ID) TABLESPACE DATA03; 
ALTER TABLE INVESTIGATION ADD CONSTRAINT EV_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID) 
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE; 
...
CREATE INDEX EV_SOURCE_FK_INDEX ON SEQUENCEFEATURE (SOURCE_ID) TABLESPACE DATA03; 
ALTER TABLE SEQUENCEFEATURE ADD CONSTRAINT EV_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID) 
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE; 
...
ALTER TABLE REFUNLINK ADD CONSTRAINT REFUNLINK_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCEDBENTITY (DBENTITY_ID) 
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE; 
ALTER TABLE REFUNLINK ADD CONSTRAINT REFUNLINK_LOCUS_FK FOREIGN KEY (LOCUS_ID) REFERENCES LOCUSDBENTITY (DBENTITY_ID) 
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON REFUNLINK TO DBSELECT; 
GRANT INSERT, SELECT, UPDATE ON REFUNLINK TO CURATOR; 
...
CERATE INDEX REFBAD_DBENT_INDEX ON REFBAD (DBENTITY_ID) TABLESPACE DATA04;
ALTER TABLE REFBAD ADD CONSTRAINT REFBAD_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID) 
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
DATASET_DESCRIPTION VARCHAR2(500),
CHANNEL_COUNT INTEGER,
CONDITION_COUNT INTEGER,
REFERENCE_ID INTEGER,
SAMPLE_DESCRIPTION VARCHAR2(500),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
 GRANT DELETE, INSERT, SELECT, UPDATE ON GENOME_RELEASE TO CURATOR;
