/* Basicobject */
DROP TABLE BASICOBJECT CASCADE CONSTRAINTS;
CREATE TABLE BASICOBJECT (
ID INTEGER NOT NULL,
...
CONSTRAINT BASICOBJECT_PK PRIMARY KEY (ID),
CONSTRAINT BASICOBJECT_UK UNIQUE (FORMAT_NAME, CLASS)) TABLESPACE DATA1;
CREATE INDEX BASICOBJECT_SOURCE_FK ON BASICOBJECT (SOURCE_ID) TABLESPACE DATA1;
GRANT SELECT ON BASICOBJECT TO DBSELECT;
GRANT INSERT, SELECT, UPDATE ON BASICOBJECT TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON BASICOBJECT TO AUXILIARY;
...
SGDID VARCHAR2(40),
STATUS VARCHAR2(40),
CONSTRAINT BIOENTITY_PK PRIMARY KEY (ID),
CONSTRAINT BIOENTITY_SGDID_UK UNIQUE (SGDID)) TABLESPACE DATA1;
ALTER TABLE BIOENTITY
ADD CONSTRAINT BIOENTITY_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
...
ALTER TABLE LOCUS
ADD CONSTRAINT LOCUS_FK FOREIGN KEY (ID) REFERENCES Bioentity (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE REFERENCE
ADD CONSTRAINT REFERENCE_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT ORGANISM_PK PRIMARY KEY (ID)) TABLESPACE DATA1;
ALTER TABLE ORGANISM
ADD CONSTRAINT ORGANISM_FK FOREIGN KEY (ID) REFERENCES BIOENTITY (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ALTER TABLE AUTHOR
ADD CONSTRAINT AUTHOR_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ALTER TABLE BOOK
ADD CONSTRAINT BOOK_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ADD CONSTRAINT CHEMICAL_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX CONTIG_STRAIN_FK_INDEX ON CONTIG (ORGANISM_ID) TABLESPACE DATA1;
ALTER TABLE CONTIG
ADD CONSTRAINT CONTIG_STRAIN_FK FOREIGN KEY (ORGANISM_ID) REFERENCES ORGANISM (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE CONTIG
ADD CONSTRAINT CONTIG_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASET
ADD CONSTRAINT DATASET_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASETCOLUMN
ADD CONSTRAINT DATASETCOLUMN_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ALTER TABLE DOMAIN
ADD CONSTRAINT DOMAIN_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ADD CONSTRAINT EXPERIMENT_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ALTER TABLE GO
ADD CONSTRAINT GO_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ALTER TABLE JOURNAL
ADD CONSTRAINT JOURNAL_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ADD CONSTRAINT OBSERVABLE_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE PHENOTYPE
ADD CONSTRAINT PHENOTYPE_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ALTER TABLE REFTYPE
ADD CONSTRAINT REFTYPE_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE RESERVEDNAME
ADD CONSTRAINT RESERVEDNAME_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ALTER TABLE SOURCE
ADD CONSTRAINT SOURCE_FK FOREIGN KEY (ID) REFERENCES BASICOBJECT (ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
