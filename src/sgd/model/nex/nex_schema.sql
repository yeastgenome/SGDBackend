...
CONSTRAINT ENZYMEANNOTATION_UK UNIQUE (DBENTITY_ID, EC_ID) ) TABLESPACE DATA08;
...
CREATE INDEX ENZYMEANNO_EC_FK_INDEX ON ENZYMEANNOTATION	(EC_ID) TABLESPACE DATA08;
...
ADD CONSTRAINT GOSUPEVID_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE GOSUPPORTINGEVIDENCE
...
ADD CONSTRAINT GOEXT_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE GOEXTENSION
...
CONSTRAINT REGULATIONANNOTATION_UK UNIQUE (DBENTITY1_ID, DBENTITY2_ID, ECO_ID, REFERENCE_ID, TAXONOMY_ID, CONDITIONS_KEY)) TABLESPACE DATA07;
...
CREATE INDEX REGANNO_ECO_FK_INDEX ON REGULATIONANNOTATION (ECO_ID) TABLESPACE DATA07;
