...
CONSTRAINT PHENOTYPEANNOTATION_UK UNIQUE (DBENTITY_ID,PHENOTYPE_ID,TAXONOMY_ID,EXPERIMENT_ID,REFERENCE_ID,MUTANT_ID,ALLELE_ID,REPORTER_ID,ASSAY_ID) ) TABLESPACE DATA04;
