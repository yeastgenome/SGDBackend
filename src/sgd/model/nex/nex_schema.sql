...
REFERENCE_ID INTEGER NOT NULL,
ECO_ID INTEGER NOT NULL,
REGULATOR_TYPE VARCHAR2(40) NOT NULL CHECK (REGULATOR_TYPE in ('transcription factor', 'chromatin modifier', 'protein modifier', 'RNA binder', 'RNA modifier', 'protein binder')),
