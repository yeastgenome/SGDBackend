...
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('PHENOTYPE', 'GO', 'ECNUMBER', 'GENINTERACTION', 'PHYSINTERACTION', 'BINDING', 'DOMAIN', 'LITERATURE', 'REGULATION', 'COMPLEX', 'DNASEQUENCE', 'PROTEINSEQUENCE', 'BIOENTITY', 'ALIAS', 'PHOSPHORYLATION')),
JSON VARCHAR2(4000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL, 
