...
DROP SEQUENCE SUPPORTINGEVIDENCE_SEQ;
CREATE SEQUENCE SUPPORTINGEVIDENCE_SEQ NOCACHE;
...
DISPLAY_NAME VARCHAR2(500) NOT NULL CHECK (DISPLAY_NAME IN ('Ontobee', 'OLS')),
OBJ_URL VARCHAR2(500) NOT NULL,
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
RO_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('Ontobee', 'OLS')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
DROP TABLE DO CASCADE CONSTRAINTS;
CREATE TABLE DO (
...
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
DOID VARCHAR2(20) NOT NULL,
DESCRIPTION VARCHAR2(2000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT DO_PK PRIMARY KEY (DO_ID),
CONSTRAINT DO_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE UNIQUE INDEX DOID_UK_INDEX on DO (DOID) TABLESPACE DATA02;
CREATE INDEX DO_SOURCE_FK_INDEX ON DO (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE DO
ADD CONSTRAINT DO_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON DO TO DBSELECT;
GRANT INSERT, SELECT, UPDATE ON DO TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON DO TO AUXILIARY;

DROP TABLE DO_ALIAS CASCADE CONSTRAINTS;
CREATE TABLE DO_ALIAS (
ALIAS_ID INTEGER NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL,
OBJ_URL VARCHAR2(500),
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
DO_ID INTEGER NOT NULL,
ALIAS_TYPE VARCHAR2(40) NOT NULL CHECK (ALIAS_TYPE IN ('EXACT','RELATED','Alternate ID','DBXREF')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT DO_ALIAS_PK PRIMARY KEY (ALIAS_ID),
CONSTRAINT DO_ALIAS_UK UNIQUE (DO_ID, DISPLAY_NAME, ALIAS_TYPE) ) TABLESPACE DATA02;
CREATE INDEX DO_ALIAS_SOURCE_FK_INDEX ON DO_ALIAS (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE DO_ALIAS
ADD CONSTRAINT DO_ALIAS_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DO_ALIAS
ADD CONSTRAINT DO_ALIAS_DO_FK FOREIGN KEY (DO_ID) REFERENCES DO (DO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON DO_ALIAS TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON DO_ALIAS TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON DO_ALIAS TO AUXILIARY;

DROP TABLE DO_URL CASCADE CONSTRAINTS;
CREATE TABLE DO_URL (
URL_ID INTEGER NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL CHECK (DISPLAY_NAME IN ('DO', 'BioPortal', 'OLS', 'Ontobee')),
OBJ_URL VARCHAR2(500) NOT NULL,
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
DO_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('DO', 'BioPortal', 'OLS', 'Ontobee')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT DO_URL_PK PRIMARY KEY (URL_ID),
CONSTRAINT DO_URL_UK UNIQUE (DO_ID, DISPLAY_NAME, OBJ_URL) ) TABLESPACE DATA02;
CREATE INDEX DO_URL_SOURCE_FK_INDEX ON DO_URL (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE DO_URL
ADD CONSTRAINT DO_URL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DO_URL
ADD CONSTRAINT DO_URL_DO_FK FOREIGN KEY (DO_ID) REFERENCES DO (DO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON DO_URL TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON DO_URL TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON DO_URL TO AUXILIARY;

DROP TABLE DO_RELATION CASCADE CONSTRAINTS;
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT DO_RELATION_PK PRIMARY KEY (RELATION_ID),
CONSTRAINT DO_RELATION_UK UNIQUE(PARENT_ID, CHILD_ID, RO_ID)) TABLESPACE DATA02;
CREATE INDEX DO_REL_CHILD_FK_INDEX ON DO_RELATION (CHILD_ID) TABLESPACE DATA02;
CREATE INDEX DO_REL_SOURCE_FK_INDEX ON DO_RELATION (SOURCE_ID) TABLESPACE DATA02;
CREATE INDEX DO_REL_RO_FK_INDEX ON DO_RELATION (RO_ID) TABLESPACE DATA02;
ALTER TABLE DO_RELATION
ADD CONSTRAINT DO_REL_CHILD_FK FOREIGN KEY (CHILD_ID) REFERENCES DO (DO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DO_RELATION
ADD CONSTRAINT DO_REL_PARENT_FK FOREIGN KEY (PARENT_ID) REFERENCES DO (DO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DO_RELATION
ADD CONSTRAINT DO_REL_RO_FK FOREIGN KEY (RO_ID) REFERENCES RO (RO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DO_RELATION
ADD CONSTRAINT DO_REL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON DO_RELATION TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON DO_RELATION TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON DO_RELATION TO AUXILIARY;
...
BUD_ID INTEGER,
EDAM_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('BioPortal','Ontobee', 'OLS')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
URL_ID INTEGER NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL CHECK (DISPLAY_NAME IN ('Ontobee', 'OLS', 'BioPortal')),
OBJ_URL VARCHAR2(500) NOT NULL,
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
OBI_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('Ontobee', 'OLS', 'BioPortal')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
CREATE TABLE SO_URL (
URL_ID INTEGER NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL CHECK (DISPLAY_NAME IN ('MISO','OLS', 'Ontobee', 'BioPortal')),
OBJ_URL VARCHAR2(500) NOT NULL,
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
SO_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('MISO','OLS', 'Ontobee', 'BioPortal')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
IS_BETA_TESTER NUMBER(1) DEFAULT 0 NOT NULL,
...
DROP TABLE DOSUBSET CASCADE CONSTRAINTS;
CREATE TABLE DOSUBSET (
DOSUBSET_ID INTEGER NOT NULL,
FORMAT_NAME VARCHAR2(100) NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL,
OBJ_URL VARCHAR2(500) NOT NULL,
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
DO_ID INTEGER NOT NULL,
SUBSET_NAME VARCHAR2(50) NOT NULL CHECK (SUBSET_NAME IN ('DO_cancer_slim','DO_MGI_slim','DO_rare_slim','GOLD','gram-negative_bacterial_infectious_disease','gram-positive_bacterial_infectious_disease','NCIthesaurus','sexually_transmitted_infectious_disease','tick-borne_infectious_disease','TopNodes_DOcancerslim','zoonotic_infectious_disease')),
GENOME_COUNT INTEGER NOT NULL,
DESCRIPTION VARCHAR2(500),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT DOSUBSET_PK PRIMARY KEY (DOSUBSET_ID),
CONSTRAINT DOSUBSET_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE INDEX DOSUBSET_DO_FK_INDEX ON DOSUBSET (DO_ID) TABLESPACE DATA02;
CREATE INDEX DOSUBSET_SOURCE_FK_INDEX ON DOSUBSET (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE DOSUBSET
ADD CONSTRAINT DOSUBSET_DO_FK FOREIGN KEY (DO_ID) REFERENCES DO (DO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DOSUBSET
ADD CONSTRAINT DOSUBSET_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON DOSUBSET TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON DOSUBSET TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON DOSUBSET TO AUXILIARY;
...
DBXREF_TYPE VARCHAR2(40) CHECK (DBXREF_TYPE IN ('GEO', 'ArrayExpress', 'Publication', 'SRA')),
DATE_PUBLIC DATE,
...
CREATE INDEX DATASET_PARENT_FK_INDEX ON DATASET (PARENT_DATASET_ID) TABLESPACE DATA02;
ALTER TABLE DATASET
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASET
ADD CONSTRAINT DATASET_PARENT_FK FOREIGN KEY (PARENT_DATASET_ID) REFERENCES DATASET (DATASET_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
BUD_ID INTEGER,
DATASET_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('GEO', 'ArrayExpress', 'SRA', 'Lab website', 'Archive website')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
...
DBXREF_ID VARCHAR2(40),
DBXREF_TYPE VARCHAR2(40) CHECK (DBXREF_TYPE IN ('GEO', 'ArrayExpress')),
...
CREATE INDEX DSETSAMP_TAX_FK_INDEX ON DATASETSAMPLE (TAXONOMY_ID) TABLESPACE DATA02;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASETSAMPLE
ADD CONSTRAINT DSETSAMP_TAX_FK FOREIGN KEY (TAXONOMY_ID) REFERENCES TAXONOMY (TAXONOMY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASETSAMPLE
...
DROP TABLE DATASETTRACK CASCADE CONSTRAINTS;
CREATE TABLE DATASETTRACK (
DATASETTRACK_ID INTEGER NOT NULL,
FORMAT_NAME VARCHAR2(100) NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL,
OBJ_URL VARCHAR2(500),
SOURCE_ID INTEGER NOT NULL,
...
CONSTRAINT DATASETTRACK_UK UNIQUE (FORMAT_NAME)) TABLESPACE DATA02;
CREATE INDEX DSETTRACK_SOURCE_FK_INDEX ON DATASETTRACK (SOURCE_ID) TABLESPACE DATA02;
CREATE INDEX DSETTRACK_DATASET_FK_INDEX ON DATASETTRACK (DATASET_ID) TABLESPACE DATA02;
ALTER TABLE DATASETTRACK
ADD CONSTRAINT DSETTRACK_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASETTRACK
ADD CONSTRAINT DSETTRACK_DATASET_FK FOREIGN KEY (DATASET_ID) REFERENCES DATASET (DATASET_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON DATASETTRACK TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON DATASETTRACK TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON DATASETTRACK TO AUXILIARY;
...
DROP TABLE DOANNOTATION CASCADE CONSTRAINTS;
CREATE TABLE DOANNOTATION (
ANNOTATION_ID INTEGER NOT NULL,
DBENTITY_ID INTEGER NOT NULL,
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
...
DO_QUALIFIER VARCHAR2(40) NOT NULL CHECK (DO_QUALIFIER IN ('enables', 'involved in', 'contributes_to')),
DATE_ASSIGNED DATE NOT NULL,
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT DOANNOTATION_PK PRIMARY KEY (ANNOTATION_ID),
CONSTRAINT DOANNOTATION_UK UNIQUE (DBENTITY_ID, DO_ID, ECO_ID, REFERENCE_ID, ANNOTATION_TYPE, DO_QUALIFIER, SOURCE_ID)) TABLESPACE DATA03;
CREATE INDEX DOANNO_REF_FK_INDEX ON DOANNOTATION (REFERENCE_ID) TABLESPACE DATA03;
CREATE INDEX DOANNO_TAX_FK_INDEX ON DOANNOTATION (TAXONOMY_ID) TABLESPACE DATA03;
CREATE INDEX DOANNO_ECO_FK_INDEX ON DOANNOTATION (ECO_ID) TABLESPACE DATA03;
CREATE INDEX DOANNO_SOURCE_FK_INDEX ON DOANNOTATION (SOURCE_ID) TABLESPACE DATA03;
CREATE INDEX DOANNO_DO_FK_INDEX ON DOANNOTATION	(DO_ID) TABLESPACE DATA03;
ALTER TABLE DOANNOTATION
ADD CONSTRAINT DOANNO_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DOANNOTATION
ADD CONSTRAINT DOANNO_TAX_FK FOREIGN KEY (TAXONOMY_ID) REFERENCES TAXONOMY (TAXONOMY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DOANNOTATION
ADD CONSTRAINT DOANNO_ECO_FK FOREIGN KEY (ECO_ID) REFERENCES ECO (ECO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DOANNOTATION
ADD CONSTRAINT DOANNO_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DOANNOTATION
ADD CONSTRAINT DOANNO_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DOANNOTATION
ADD CONSTRAINT DOANNO_DO_FK FOREIGN KEY (DO_ID) REFERENCES GO (DO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON DOANNOTATION TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON DOANNOTATION TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON DOANNOTATION TO AUXILIARY;

DROP TABLE DOSUPPORTINGEVIDENCE CASCADE CONSTRAINTS;
CREATE TABLE DOSUPPORTINGEVIDENCE (
DOSUPPORTINGEVIDENCE_ID INTEGER NOT NULL,
ANNOTATION_ID INTEGER NOT NULL,
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT DOSUPPORTINGEVIDENCE_PK PRIMARY KEY (DOSUPPORTINGEVIDENCE_ID),
CONSTRAINT DOSUPPORTINGEVIDENCE_UK UNIQUE (ANNOTATION_ID, DBXREF_ID, GROUP_ID, EVIDENCE_TYPE)) TABLESPACE DATA03;
ALTER TABLE DOSUPPORTINGEVIDENCE
ADD CONSTRAINT DOSUPEVID_ANNO_FK FOREIGN KEY (ANNOTATION_ID) REFERENCES DOANNOTATION (ANNOTATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON DOSUPPORTINGEVIDENCE TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON DOSUPPORTINGEVIDENCE TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON DOSUPPORTINGEVIDENCE TO AUXILIARY;

DROP TABLE DOSUBSETANNOTATION CASCADE CONSTRAINTS;
CREATE TABLE DOSUBSETANNOTATION (
ANNOTATION_ID INTEGER NOT NULL,
DBENTITY_ID INTEGER NOT NULL,
SOURCE_ID INTEGER NOT NULL,
BUD_ID INTEGER,
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT DOSUBSETANNOTATION_PK PRIMARY KEY (ANNOTATION_ID),
CONSTRAINT DOSUBSETANNOTATION_UK UNIQUE (DBENTITY_ID, DOSUBSET_ID)) TABLESPACE DATA03;
CREATE INDEX DOSUBSETANNO_REF_FK_INDEX ON DOSUBSETANNOTATION (REFERENCE_ID) TABLESPACE DATA03;
CREATE INDEX DOSUBSETANNO_TAX_FK_INDEX ON DOSUBSETANNOTATION (TAXONOMY_ID) TABLESPACE DATA03;
CREATE INDEX DOSUBSETANNO_SOURCE_FK_INDEX ON DOSUBSETANNOTATION (SOURCE_ID) TABLESPACE DATA03;
CREATE INDEX DOSUBSETANNO_DOSUBSET_FK_INDEX ON DOSUBSETANNOTATION	(DOSUBSET_ID) TABLESPACE DATA03;
ALTER TABLE DOSUBSETANNOTATION
ADD CONSTRAINT DOSUBSETANNO_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DOSUBSETANNOTATION
ADD CONSTRAINT DOSUBSETANNO_TAX_FK FOREIGN KEY (TAXONOMY_ID) REFERENCES TAXONOMY (TAXONOMY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DOSUBSETANNOTATION
ADD CONSTRAINT DOSUBSETANNO_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DOSUBSETANNOTATION
ADD CONSTRAINT DOSUBSETANNO_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DOSUBSETANNOTATION
ADD CONSTRAINT DOSUBSETANNO_DOSUBSET_FK FOREIGN KEY (DOSUBSET_ID) REFERENCES DOSUBSET (DOSUBSET_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON DOSUBSETANNOTATION TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON DOSUBSETANNOTATION TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON DOSUBSETANNOTATION TO AUXILIARY;
...
ANNOTATION_ID INTEGER NOT NULL,
CONDITION_CLASS VARCHAR2(40) NOT NULL CHECK (CONDITION_CLASS IN ('assay', 'media', 'phase', 'radiation', 'temperature', 'treatment', 'chemical')),
CONDITION_NAME VARCHAR2(500) NOT NULL,
CONDITION_VALUE VARCHAR2(150),
...
REFERENCE_ID INTEGER NOT NULL,
ECO_ID INTEGER NOT NULL,
REGULATOR_TYPE VARCHAR2(40) NOT NULL CHECCK (REGULATOR_TYPE in ('transcription factor', 'chromatin modifier', 'protein modifier', 'RNA binder', 'RNA modifier', 'protein binder')),
REGULATION_TYPE VARCHAR2(100) NOT NULL CHECK (REGULATION_TYPE in ('transcription', 'RNA stability', 'protein activity', 'protein stability')),
DIRECTION VARCHAR2(10),
HAPPENS_DURING INTEGER,
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT REGULATIONANNOTATION_PK PRIMARY KEY (ANNOTATION_ID),
CONSTRAINT REGULATIONANNOTATION_UK UNIQUE (TARGET_ID, REGULATOR_ID, ECO_ID, REFERENCE_ID)) TABLESPACE DATA03;
...
CREATE INDEX REGANNO_REGULATOR_FK_INDEX ON REGULATIONANNOTATION (REGULATOR_ID) TABLESPACE DATA03;
CREATE INDEX REGANNO_HAPDUR_FK_INDEX ON REGULATIONANNOTATION (HAPPENS_DURING) TABLESPACE DATA03;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE REGULATIONANNOTATION 
ADD CONSTRAINT REGANNO_REGULATOR_FK FOREIGN KEY (REGULATOR_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE REGULATIONANNOTATION 
ADD CONSTRAINT REGANNO_TARGET_FK FOREIGN KEY (TARGET_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE REGULATIONANNOTATION
ADD CONSTRAINT REGANNO_HAPDUR_FK FOREIGN KEY (HAPPENS_DURING) REFERENCES GO (GO_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
