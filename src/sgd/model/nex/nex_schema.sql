...
FORMAT_NAME VARCHAR2(100) NOT NULL, 
DISPLAY_NAME VARCHAR2(500) NOT NULL,
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('ALLELE', 'DOMAIN', 'CHEMICAL', 'ORPHAN', 'CONTIG', 'DATASET')),
OBJ_URL VARCHAR2(500), 
SOURCE_ID INTEGER NOT NULL,
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DATASETBIOITEM
ADD CONSTRAINT DATASETBIOITEM_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCE (REFERENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT EXPRESSIONEVIDENCE_UK UNIQUE (DATASET_ID, CONDITION)) TABLESPACE DATA2;
...
CREATE INDEX EXPEV_DSET_FK_INDEX ON EXPRESSIONEVIDENCE (DATASET_ID) TABLESPACE DATA2;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE EXPRESSIONEVIDENCE
ADD CONSTRAINT EXPEV_DSET_FK FOREIGN KEY (DATASET_ID) REFERENCES DATASETBIOITEM (BIOITEM_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT BIOENTDATA_PK PRIMARY KEY (BIOENTITYDATA_ID),
CONSTRAINT BIOENTDATA_UK UNIQUE (EVIDENCE_ID, BIOENTITY_ID)) TABLESPACE DATA3;
CREATE INDEX BIOENTDATA_BIOENT_FK_INDEX ON BIOENTITYDATA (BIOENTITY_ID) TABLESPACE DATA3;
ALTER TABLE BIOENTITYDATA
ADD CONSTRAINT BIOENTDATA_EV_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES EVIDENCE (EVIDENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE BIOENTITYDATA
ADD CONSTRAINT BIOENTDATA_BIOENT_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES BIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
DROP SEQUENCE BIOENTDAT_SEQ;
CREATE SEQUENCE BIOENTDAT_SEQ NOCACHE;
...
EXPERIMENT_ID INTEGER NULL,
STRAIN_ID INTEGER NULL,
BIOENTITY_ID INTEGER,
CATEGORY VARCHAR2(100),
HISTORY_TYPE VARCHAR2(50),
NOTE VARCHAR2(4000),
...
EVIDENCE_COUNT DECIMAL(7, 3) NOT NULL,
