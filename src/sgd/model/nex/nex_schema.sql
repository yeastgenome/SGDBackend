...
CONSTRAINT QUALITY_UK UNIQUE (FORMAT_NAME, CLASS, DISPLAY_NAME) ) TABLESPACE DATA1;
CREATE INDEX QUAL_SOURCE_FK_INDEX ON QUALITY (SOURCE_ID) TABLESPACE DATA1;
ALTER TABLE QUALITY
ADD CONSTRAINT QUAL_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
DROP SEQUENCE QUALITY_SEQ;
CREATE SEQUENCE QUALITY_SEQ NOCACHE;
GRANT SELECT ON QUALITY TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON QUALITY TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON QUALITY TO AUXILIARY;
...
DROP TABLE QUALITY_REFERENCE CASCADE CONSTRAINTS;
CREATE TABLE QUALITY_REFERENCE (
QUALITY_REFERENCE_ID INTEGER NOT NULL,
QUALITY_ID INTEGER NOT NULL,
REFERENCE_ID INTEGER NOT NULL,
CONSTRAINT QUALITY_REFERENCE_PK PRIMARY KEY (QUALITY_REFERENCE_ID),
CONSTRAINT QUALITY_REFERENCE_UK UNIQUE (QUALITY_ID, REFERENCE_ID) ) TABLESPACE DATA1;
CREATE INDEX QUALREF_REF_FK_INDEX ON QUALITY_REFERENCE (REFERENCE_ID) TABLESPACE DATA1;
CREATE INDEX QUALREF_PAR_FK_INDEX ON QUALITY_REFERENCE (QUALITY_ID) TABLESPACE DATA1;
ALTER TABLE QUALITY_REFERENCE
ADD CONSTRAINT QUALREF_PARA_FK FOREIGN KEY (QUALITY_ID) REFERENCES QUALITY (QUALITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE QUALITY_REFERENCE
ADD CONSTRAINT QUALREF_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCE (REFERENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
DROP SEQUENCE QUALREF_SEQ;
CREATE SEQUENCE QUALREF_SEQ NOCACHE;
GRANT SELECT ON QUALITY_REFERENCE TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON QUALITY_REFERENCE TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON QUALITY_REFERENCE TO AUXILIARY;

DROP TABLE ALIAS_REFERENCE CASCADE CONSTRAINTS;
CREATE TABLE ALIAS_REFERENCE (
ALIAS_REFERENCE_ID INTEGER NOT NULL,
ALIAS_ID INTEGER NOT NULL,
REFERENCE_ID INTEGER NOT NULL,
CONSTRAINT ALIAS_REFERENCE_PK PRIMARY KEY (ALIAS_REFERENCE_ID),
CONSTRAINT ALIAS_REFERENCE_UK UNIQUE (ALIAS_ID, REFERENCE_ID) ) TABLESPACE DATA1;
CREATE INDEX ALIASREF_REF_FK_INDEX ON ALIAS_REFERENCE (REFERENCE_ID) TABLESPACE DATA1;
CREATE INDEX ALAISREF_PAR_FK_INDEX ON ALIAS_REFERENCE (ALIAS_ID) TABLESPACE DATA1;
ALTER TABLE ALIAS_REFERENCE
ADD CONSTRAINT ALIAS_REF_FK FOREIGN KEY (ALIAS_ID) REFERENCES ALIAS (ALIAS_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE ALIAS_REFERENCE
ADD CONSTRAINT ALIASREF_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCE (REFERENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
DROP SEQUENCE ALIASREF_SEQ;
CREATE SEQUENCE ALIASREF_SEQ NOCACHE;
GRANT SELECT ON ALIAS_REFERENCE TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON ALIAS_REFERENCE TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON ALIAS_REFERENCE TO AUXILIARY;

DROP TABLE RELATION_REFERENCE CASCADE CONSTRAINTS;
CREATE TABLE RELATION_REFERENCE (
RELATION_REFERENCE_ID INTEGER NOT NULL,
RELATION_ID INTEGER NOT NULL,
REFERENCE_ID INTEGER NOT NULL,
CONSTRAINT RELATION_REFERENCE_PK PRIMARY KEY (RELATION_REFERENCE_ID),
CONSTRAINT RELATION_REFERENCE_UK UNIQUE (RELATION_ID, REFERENCE_ID) ) TABLESPACE DATA1;
CREATE INDEX RELATIONREF_REF_FK_INDEX ON RELATION_REFERENCE (REFERENCE_ID) TABLESPACE DATA1;
CREATE INDEX RELATIONREF_RELATION_FK_INDEX ON RELATION_REFERENCE (RELATION_ID) TABLESPACE DATA1;
ALTER TABLE RELATION_REFERENCE
ADD CONSTRAINT RELATIONREF_RELATION_FK FOREIGN KEY (RELATION_ID) REFERENCES RELATION (RELATION_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE RELATION_REFERENCE
ADD CONSTRAINT RELATIONREF_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCE (REFERENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
DROP SEQUENCE RELATIONREF_SEQ;
CREATE SEQUENCE RELATIONREF_SEQ NOCACHE;
GRANT SELECT ON RELATION_REFERENCE TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON RELATION_REFERENCE TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON RELATION_REFERENCE TO AUXILIARY;
...
FORMAT_NAME VARCHAR2(100) NOT NULL, 
DISPLAY_NAME VARCHAR2(500) NOT NULL,
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('ALLELE', 'DOMAIN', 'CHEMICAL', 'ORPHAN', 'CONTIG', 'DATASET', 'DATASETCOLUMN')),
OBJ_URL VARCHAR2(500), 
SOURCE_ID INTEGER NOT NULL,
DESCRIPTION VARCHAR2(400) NULL,
...
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('LOCUS', 'COMPLEX')),
...
DROP TABLE BIOENTITYQUALITY CASCADE CONSTRAINTS;
CREATE TABLE BIOENTITYQUALITY (
QUALITY_ID INTEGER NOT NULL,
BIOENTITY_ID INTEGER NOT NULL,
CONSTRAINT BIOENTITYQUALITY_PK PRIMARY KEY (QUALITY_ID) ) TABLESPACE DATA1;
CREATE INDEX BIOENTQUALITY_BIOENT_FK_INDEX ON BIOENTITYQUALITY (BIOENTITY_ID) TABLESPACE DATA1;
ALTER TABLE BIOENTITYQUALITY
ADD CONSTRAINT BIOENTQUAL_QUAL_FK FOREIGN KEY (QUALITY_ID) REFERENCES QUALITY (QUALITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE BIOENTITYQUALITY
ADD CONSTRAINT BIOENTQUAL_BIOENT_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES BIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON BIOENTITYQUALITY TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON BIOENTITYQUALITY TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON BIOENTITYQUALITY TO AUXILIARY;
...
DESCENDANT_ANNOTATION_COUNT INTEGER,
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL, 
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL, 
...
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('PHENOTYPE', 'GO', 'ECNUMBER', 'GENINTERACTION', 'PHYSINTERACTION', 'BINDING', 'DOMAIN', 'LITERATURE', 'REGULATION', 'COMPLEX', 'DNASEQUENCE', 'PROTEINSEQUENCE', 'BIOENTITY', 'ALIAS', 'PHOSPHORYLATION', 'PROTEINEXPERIMENT', 'EXPRESSION', 'HISTORY')),
JSON VARCHAR2(4000),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL, 
...
SUBCLASS VARCHAR(40) CHECK (SUBCLASS IN ('LOCUS', 'COMPLEX', 'GO', 'PHENOTYPE', 'OBSERVABLE', 'ECNUMBER', 'DOMAIN', 'CONTIG', 'CHEMICAL', 'DATASET', 'DATASETCOLUMN')),
