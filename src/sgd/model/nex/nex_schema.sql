...
CONSTRAINT BIOENTITYDATA_UK UNIQUE (EVIDENCE_ID, BIOENTITY_ID)) TABLESPACE DATA2;
CREATE INDEX BIOENTDAT_BIOENT_FK_INDEX ON BIOENTITYDATA (BIOENTITY_ID) TABLESPACE DATA2;
CREATE INDEX BIOENTDAT_EV_FK_INDEX ON BIOENTITYDATA (EVIDENCE_ID) TABLESPACE DATA2;
ALTER TABLE BIOENTITYDATA
ADD CONSTRAINT BIOENTDAT_EV_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES EVIDENCE (EVIDENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE BIOENTITYDATA
ADD CONSTRAINT BIOENTDAT_BIOENT_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES BIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
