...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DNASEQUENCEANNOTATION
ADD CONSTRAINT DNASEQANNO_FILE_FK FOREIGN KEY (FILE_ID) REFERENCES FILE (FILE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
DBENTITY_ID INTEGER NOT NULL,
DISPLAY_NAME VARCHAR2(500) NOT NULL,
DNASUBSEQUENCE_TYPE VARCHAR2(40) NOT NULL,
...
CONSTRAINT DNASUBSEQUENCE_UK UNIQUE (ANNOTATION_ID, DBENTITY_ID, DNASUBSEQUENCE_TYPE, RELATIVE_START_INDEX, RELATIVE_END_INDEX)) TABLESPACE DATA03;
CREATE INDEX DNASUBSEQ_DBENTITY_FK_INDEX ON DNASUBSEQUENCE (DBENTITY_ID) TABLESPACE DATA03;
CREATE INDEX DNASUBSEQ_GENRELEASE_FK_INDEX ON DNASUBSEQUENCE (GENOMERELEASE_ID) TABLESPACE DATA03;
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DNASUBSEQUENCE
ADD CONSTRAINT DNASUBSEQ_DBENTITY_FK FOREIGN KEY (DBENTITY_ID) REFERENCES LOCUSDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE DNASUBSEQUENCE
ADD CONSTRAINT DNASUBSEQ_GENRELEASE_FK FOREIGN KEY (GENOMERELEASE_ID) REFERENCES GENOMERELEASE (GENOMERELEASE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
DROP TABLE PROTEINSEQUENCE_DETAILS CASCADE CONSTRAINTS;
CREATE TABLE PROTEINSEQUENCE_DETAILS (
DETAIL_ID INTEGER NOT NULL,
ANNOTATION_ID INTEGER NOT NULL,
