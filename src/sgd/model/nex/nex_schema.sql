...
DROP TABLE NOTEANNOTATION CASCADE CONSTRAINTS;
...
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
CONSTRAINT NOTEANNOTATION_PK PRIMARY KEY (ANNOTATION_ID),
CONSTRAINT NOTEANNOTATION_UK UNIQUE (DBENTITY_ID, NOTE_TYPE, DISPLAY_NAME, NOTE) ) TABLESPACE DATA03;
CREATE INDEX NOTEANNO_REF_FK_INDEX ON NOTEANNOTATION (REFERENCE_ID) TABLESPACE DATA03;
CREATE INDEX NOTEANNO_TAX_FK_INDEX ON NOTEANNOTATION (TAXONOMY_ID) TABLESPACE DATA03;
CREATE INDEX NOTEANNO_SOURCE_FK_INDEX ON NOTEANNOTATION (SOURCE_ID) TABLESPACE DATA03;
ALTER TABLE NOTEANNOTATION
ADD CONSTRAINT NOTEANNO_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCEDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE NOTEANNOTATION
ADD CONSTRAINT NOTEANNO_TAX_FK FOREIGN KEY (TAXONOMY_ID) REFERENCES TAXONOMY (TAXONOMY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE NOTEANNOTATION
ADD CONSTRAINT NOTEANNO_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE NOTEANNOTATION
ADD CONSTRAINT NOTEANNO_DBENT_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON NOTEANNOTATION TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON NOTEANNOTATION TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON NOTEANNOTATION TO AUXILIARY;
...
CONSTRAINT PHENOTYPEANNOTATION_COND_UK UNIQUE (ANNOTATION_ID, CONDITION_TYPE, CONDITION_NAME, CONDITION_VALUE) ) TABLESPACE DATA03;
...
CONSTRAINT PROTEINEXPTANNOTATION_COND_UK UNIQUE (ANNOTATION_ID, CONDITION_TYPE, CONDITION_NAME, CONDITION_VALUE) ) TABLESPACE DATA03;
...
CURATION_TASK VARCHAR2(40) NOT NULL,
...
CONSTRAINT ARCH_LOCUSCHANGE_UK UNIQUE (DBENTITY_ID, CHANGE_TYPE, OLD_VALUE, NEW_VALUE, DATE_CHANGED) ) TABLESPACE DATA04;
...
CONSTRAINT ARCH_LITERATUREANNOTATION_UK1 UNIQUE (ANNOTATION_ID),
CONSTRAINT ARCH_LITERATUREANNOTATION_UK2 UNIQUE (DBENTITY_ID, REFERENCE_ID, TOPIC) ) TABLESPACE DATA04;
...
CREATED_BY VARCHAR2(12) NOT NULL,
DATE_ARCHIVED DATE DEFAULT SYSDATE NOT NULL,
CONSTRAINT ARCH_CONTIG_PK PRIMARY KEY (ARCHIVE_ID),
CONSTRAINT ARCH_CONTIG_UK1 UNIQUE (CONTIG_ID),
CONSTRAINT ARCH_CONTIG_UK2 UNIQUE (FORMAT_NAME)) TABLESPACE DATA04
LOB (RESIDUES) store as SECUREFILE (TABLESPACE LOB01
enable storage in row CHUNK 8K nocache nologging retention none);
...
CREATED_BY VARCHAR2(12) NOT NULL,
DATE_ARCHIVED DATE DEFAULT SYSDATE NOT NULL,
CONSTRAINT ARCH_DNASEQANNOTATION_PK PRIMARY KEY (ARCHIVE_ID),
CONSTRAINT ARCH_DNASEQANNOTATION_UK1 UNIQUE (ANNOTATION_ID),
CONSTRAINT ARCH_DNASEQANNOTATION_UK2 UNIQUE (DBENTITY_ID, TAXONOMY_ID, CONTIG_ID, SO_ID, DNA_TYPE) ) TABLESPACE DATA04
LOB (RESIDUES) store as SECUREFILE (TABLESPACE LOB01
enable storage in row CHUNK 8K nocache nologging retention none);
...
CREATED_BY VARCHAR2(12) NOT NULL,
DATE_ARCHIVED DATE DEFAULT SYSDATE NOT NULL,
CONSTRAINT ARCH_DNASUBSEQUENCE_PK PRIMARY KEY (ARCHIVE_ID),
CONSTRAINT ARCH_DNASUBSEQUENCE_UK1 UNIQUE (DNASUBSEQUENCE_ID),
CONSTRAINT ARCH_DNASUBSEQUENCE_UK2 UNIQUE (ANNOTATION_ID, DBENTITY_ID, RELATIVE_START_INDEX, RELATIVE_END_INDEX)) TABLESPACE DATA04
LOB (RESIDUES) store as SECUREFILE (TABLESPACE LOB01
enable storage in row CHUNK 8K nocache nologging retention none);
...
CREATED_BY VARCHAR2(12) NOT NULL,
DATE_ARCHIVED DATE DEFAULT SYSDATE NOT NULL,
CONSTRAINT ARCH_PROTEINSEQANNOTATION_PK PRIMARY KEY (ARCHIVE_ID),
CONSTRAINT ARCH_PROTEINSEQANNOTATION_UK1 UNIQUE (ANNOTATION_ID),
CONSTRAINT ARCH_PROTEINSEQANNOTATION_UK2 UNIQUE (DBENTITY_ID, TAXONOMY_ID, CONTIG_ID) ) TABLESPACE DATA04
LOB (RESIDUES) store as SECUREFILE (TABLESPACE LOB01
enable storage in row CHUNK 8K nocache nologging retention none);
