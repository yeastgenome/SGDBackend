...
CONSTRAINT POSTTRANSLATIONALANNOTATION_UK UNIQUE (DBENTITY_ID, PSIMOD_ID, SITE_RESIDUE, SITE_INDEX, REFERENCE_ID) ) TABLESPACE DATA03;
...
CREATE INDEX PTRANSANNO_PSIMOD_FK_INDEX ON POSTTRANSLATIONALANNOTATION (PSIMOD_ID) TABLESPACE DATA03;
