...
CLASS VARCHAR(40) NOT NULL CHECK (CLASS IN ('BIOENTITY', 'BIOCONCEPT', 'BIOITEM', 'REFERENCE', 'AUTHOR', 'STRAIN')),
SUBCLASS VARCHAR(40) CHECK (SUBCLASS IN ('LOCUS', 'COMPLEX', 'GO', 'PHENOTYPE', 'OBSERVABLE', 'EC_NUMBER', 'DOMAIN', 'CONTIG', 'CHEMICAL')),
