...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE LOCUS_DOCUMENT
ADD CONSTRAINT LOC_DOC_LOC_FK FOREIGN KEY (LOCUS_ID) REFERENCES LOCUSDBENTITY (DBENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CONSTRAINT LOCUS_DOCUMENT_REFERENCE_UK UNIQUE (DOCUMENT_ID, REFERENCE_ID, REFERENCE_ORDER)) TABLESPACE DATA04;
