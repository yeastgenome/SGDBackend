...
FILE_STATUS VARCHAR2(40) NOT NULL,
FILE_DATA_TYPE VARCHAR2(100) NOT NULL,
FILE_OPERATION VARCHAR2(100) NOT NULL,
FILE_VERSION VARCHAR2(40) NOT NULL,
FILE_FORMAT VARCHAR2(100) NOT NULL,
...
BUD_ID INTEGER,
PROTEINDOMAIN_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('InterPro','PROSITE','HAMAP','Pfam','PRINTS','ProDom','SMART','TIGRFAM','PIRSF','SUPERFAMILY','GENE3D','PANTHER')),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
