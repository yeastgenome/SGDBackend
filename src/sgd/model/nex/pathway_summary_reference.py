...
from src.sgd.model.nex.pathway import PathwaySummary
from src.sgd.model.nex.reference import Reference


__author__ = 'sweng66'

class PathwaySummaryReference(Base, EqualityByIDMixin, ToJsonMixin, UpdateWithJsonMixin):
    __tablename__ = 'pathway_summary_reference'

    id = Column('summary_reference_id', Integer, primary_key=True)
    summary_id = Column('summary_id', Integer, ForeignKey(PathwaySummary.id))
