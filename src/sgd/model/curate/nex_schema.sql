...
CREATE INDEX LOCUSDBENTITY_SEQFEAT_FK_INDEX ON DBENTITY (SOURCE_ID) TABLESPACE DATA02;
ALTER TABLE LOCUSDBENTITY
ADD CONSTRAINT LOCUSDBENTITY_LOCUS_FK FOREIGN KEY (DBENTITY_ID) REFERENCES DBENTITY (DBENTITY_ID);
ALTER TABLE LOCUSDBENTITY
ADD CONSTRAINT LOCUSDBENTITY_SEQFEAT_FK_FK FOREIGN KEY (SEQUENCEFEATURE_ID) REFERENCES SEQUENCEFEATURE (SEQUENCEFEATURE_ID);
...
DBENTITY_ID INTEGER NOT NULL,
METHOD_OBTAINED VARCHAR2(40) NOT NULL CHECK (METHOD_OBTAINED IN ('Epub ahead of print', 'In preparation', 'In press', 'Published', 'Submited', 'Unpublished')),
...
BUD_ID INTEGER,
COLLEAGUE_ID INTEGER NOT NULL,
URL_TYPE VARCHAR2(40) NOT NULL CHECK (URL_TYPE IN ('Lab', 'Reference supplement', 'Research summary'),
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL,
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL,
