...
JSON CLOB NOT NULL,
CONSTRAINT EXPERIMENT_PK PRIMARY KEY (EXPERIMENT_ID) ) TABLESPACE PDATA1;
...
JSON CLOB NOT NULL,
CONSTRAINT TAG_PK PRIMARY KEY (TAG_ID) ) TABLESPACE PDATA1;
...
BIOENTITY_ID INTEGER NOT NULL,
CLASS VARCHAR2(40) NOT NULL CHECK (CLASS IN ('INTERACTION', 'REGULATION', 'LITERATURE', 'GO', 'PHENOTYPE', 'PROTEIN_DOMAIN', 'EXPRESSION')),
JSON CLOB,
...
BIOENTITY_ID INTEGER NOT NULL,
CLASS VARCHAR2(40) NOT NULL CHECK (CLASS IN ('REGULATION', 'INTERACTION', 'GO', 'PHENOTYPE', 'LITERATURE', 'BINDING', 'PROTEIN_DOMAIN', 'BINDING_SITE', 'EC_NUMBER', 'PROTEIN_EXPERIMENT', 'PROTEIN_PHOSPHORYLATION', 'SEQUENCE', 'NEIGHBOR_SEQUENCE', 'EXPRESSION', 'POSTTRANSLATIONAL', 'ALIGNMENT')),
JSON CLOB,
...
BIOITEM_ID INTEGER NOT NULL,
CLASS VARCHAR2(40) NOT NULL CHECK (CLASS IN ('PROTEIN_DOMAIN_LOCUS', 'PHENOTYPE', 'SEQUENCE')),
JSON CLOB,
...
DROP TABLE BIOITEM_ENRICHMENT CASCADE CONSTRAINTS;
CREATE TABLE BIOITEM_ENRICHMENT (
BIOITEM_ENRICHMENT_ID INTEGER NOT NULL,
BIOITEM_ID INTEGER NOT NULL,
CLASS VARCHAR2(40) NOT NULL CHECK (CLASS IN ('ENRICHMENT')),
JSON CLOB,
CONSTRAINT BIOITEM_ENRICHMENT_PK PRIMARY KEY (BIOITEM_ENRICHMENT_ID),
CONSTRAINT BIOITEM_ENRICHMENT_UK UNIQUE (BIOITEM_ID, CLASS)) TABLESPACE PDATA1;
CREATE INDEX BIOITEM_ENRICHMENT_FK_INDX ON BIOITEM_ENRICHMENT (BIOITEM_ID) TABLESPACE PDATA1;
CREATE INDEX BIOITEM_ENRICHMENT_CLS_INDX ON BIOITEM_ENRICHMENT (CLASS) TABLESPACE PDATA1;
GRANT SELECT ON BIOITEM_ENRICHMENT TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON BIOITEM_ENRICHMENT TO AUXILIARY;
DROP SEQUENCE BIOITEM_ENRICHMENT_SEQ;
CREATE SEQUENCE BIOITEM_ENRICHMENT_SEQ NOCACHE;
