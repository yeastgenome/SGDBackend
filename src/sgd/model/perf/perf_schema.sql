...
BIOENTITY_ID INTEGER NOT NULL,
CLASS VARCHAR2(40) NOT NULL CHECK (CLASS IN ('REGULATION', 'INTERACTION', 'GO', 'PHENOTYPE', 'LITERATURE', 'BINDING', 'PROTEIN_DOMAIN', 'BINDING_SITE', 'EC_NUMBER', 'PROTEIN_EXPERIMENT', 'PROTEIN_PHOSPHORYLATION', 'SEQUENCE', 'NEIGHBOR_SEQUENCE', 'EXPRESSION')),
JSON CLOB,
