...
JSON CLOB NOT NULL,
CONSTRAINT ONTOLOGY_PK PRIMARY KEY (ONTOLOGY_ID)) TABLESPACE PDATA2;
GRANT SELECT ON ONTOLOGY TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON ONTOLOGY TO AUXILIARY;
DROP SEQUENCE ONTOLOGY_SEQ;
CREATE SEQUENCE ONTOLOGY_SEQ NOCACHE;
...
AUTHOR_DETAILS_ID INTEGER NOT NULL,
AUTHOR_ID INTEGER NOT NULL,
CLASS VARCHAR2(40) NOT NULL CHECK (CLASS IN ('REFERENCE')),
JSON CLOB NOT NULL,
CONSTRAINT AUTHOR_REFERENCES_PK PRIMARY KEY (AUTHOR_DETAILS_ID),
CONSTRAINT AUTHOR_REFERENCES_UK UNIQUE (AUTHOR_ID, CLASS)) TABLESPACE PDATA2;
GRANT SELECT ON AUTHOR_DETAILS TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON AUTHOR_DETAILS TO AUXILIARY;
DROP SEQUENCE AUTHOR_DETAILS_SEQ;
CREATE SEQUENCE AUTHOR_DETAILS_SEQ NOCACHE;
