...
class Sequence(Base, EqualityByIDMixin):
    ...
    feature_id = Column('feature_no', String, ForeignKey('from_bud.feature.feature_no'))
...
class Feat_Location(Base, EqualityByIDMixin):
    ...
    sequence_id = Column('seq_no', Integer, ForeignKey('from_bud.seq.seq_no'))
    rootseq_id = Column('rootseq_no', Integer, ForeignKey('from_bud.seq.seq_no'))
