...
if __name__ == "__main__":
    ...
    do_conversion(make_author_starter(bud_session_maker, nex_session_maker),
                  [Json2Obj(Author),
                   Obj2NexDB(nex_session_maker, lambda x: x.query(Author), name='convert.from_bud.author', delete_untouched=True, commit_interval=1000)])
    ...
    do_conversion(make_ref_reftype_starter(bud_session_maker, nex_session_maker),
                  [Json2Obj(ReferenceReftype),
                   Obj2NexDB(nex_session_maker, lambda x: x.query(ReferenceReftype), name='convert.from_bud.reference_reftype', delete_untouched=True, commit_interval=1000)])
