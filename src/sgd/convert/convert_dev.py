...
from src.sgd.convert.transformers import do_conversion, Obj2NexDB, Json2Obj, OutputTransformer, make_file_starter, \
    make_backend_starter, Json2CorePerfDB, Json2DataPerfDB, Evidence2NexDB, make_locus_data_backend_starter, \
    ...
    Json2DisambigPerfDB, make_orphan_backend_starter, Json2OrphanPerfDB, make_go_data_with_children_backend_starter
import os
__author__ = 'kpaskov'
...
if __name__ == "__main__":   
    ...
    #                Obj2NexDB(nex_session_maker, lambda x: x.query(AuthorReference), name='convert.from_bud.author_reference', delete_untouched=True, commit_interval=1000),
    #                OutputTransformer(1000)])
    #
