...
new_sequence_files = [("src/sgd/convert/data/strains/Sigma1278b-10560-6B_JRIQ00000000.gff", 'src/sgd/convert/data/strains/Sigma1278b-10560-6B_JRIQ00000000_cds.fsa', 'Sigma1278b'),
                      ...
                      ("src/sgd/convert/data/strains/D273-10B_JRIY00000000.gff", "src/sgd/convert/data/strains/D273-10B_JRIY00000000_cds.fsa", 'D273'),
                      ...
                      ("src/sgd/convert/data/strains/JK9-3d_JRIZ00000000.gff", "src/sgd/convert/data/strains/JK9-3d_JRIZ00000000_cds.fsa", 'JK9'),
                      ...
                      ("src/sgd/convert/data/strains/SEY6210_JRIW00000000.gff", "src/sgd/convert/data/strains/SEY6210_JRIW00000000_cds.fsa", 'SEY'),
                      ...
                      ("src/sgd/convert/data/strains/X2180-1A_JRIX00000000.gff", "src/sgd/convert/data/strains/X2180-1A_JRIX00000000_cds.fsa", 'X2180'),
...
protein_sequence_files = [
    ("src/sgd/convert/data/strains/orf_trans_all_R64-1-1_20110203.fasta", 'S288C'),
                      ...
                      ('src/sgd/convert/data/strains/D273-10B_JRIY00000000_pep.fsa', 'D273'),
                      ...
                      ('src/sgd/convert/data/strains/JK9-3d_JRIZ00000000_pep.fsa', 'JK9'),
                      ...
                      ('src/sgd/convert/data/strains/SEY6210_JRIW00000000_pep.fsa', 'SEY'),
                      ...
                      ('src/sgd/convert/data/strains/X2180-1A_JRIX00000000_pep.fsa', 'X2180'),
