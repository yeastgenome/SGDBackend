...
protein_sequence_files = [
    ("src/sgd/convert/data/strains/orf_trans_all_R64-1-1_20110203.fasta", 'S288C'),
                      ...
                      ('src/sgd/convert/data/strains/10560_6B.pep.fsa', '10560-6B'),
                      ...
                      ('src/sgd/convert/data/strains/BC187.pep.fsa', 'BC187'),
                      ('src/sgd/convert/data/strains/BY4741.pep.fsa', 'BY4741'),
                      ('src/sgd/convert/data/strains/BY4742.pep.fsa', 'BY4742'),
