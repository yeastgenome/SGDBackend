...
sequence_files = [(["src/sgd/convert/data/strains/saccharomyces_cerevisiae.gff"], ["src/sgd/convert/data/strains/orf_coding_all_R64-1-1_20110203.fasta", "rna_coding_R64-1-1_20110203.fasta"], 'S288C'),
