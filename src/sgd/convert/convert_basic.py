...
if __name__ == "__main__":   
    ...
    pastry_master_converter.convert_basic()
    master_db1_converter.convert_basic()
    db1_db2_converter.convert_basic()

    pastry_master_converter.convert_basic_continued()
    master_db1_converter.convert_basic_continued()
    db1_db2_converter.convert_basic_continued()
