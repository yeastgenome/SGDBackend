...
def referenceunlink_starter(bud_session_maker):
...
if __name__ == '__main__':
    from src.sgd.convert import config
    basic_convert(config.BUD_HOST, config.NEX_HOST, referenceunlink_starter, 'referenceunlink', lambda x: (x['dbentity_id'], x['reference_id']))
