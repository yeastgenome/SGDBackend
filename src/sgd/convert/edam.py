...
def edam_starter(bud_session_maker):
    ...
    for term in terms:
        ...
        term['urls'].append({'display_name': 'OLS',
                             'link': 'http://www.ebi.ac.uk/ols/ontologies/edam/terms?iri=http%3A%2F%2Fedamontology.org%2F' + link_id,
    ...
    f = open('src/sgd/convert/data/published_datasets_metadata_file-20160804.txt')    
    found = {}
    i = 0
    for line in f:
...
def read_owl(filename, parent_to_children, is_obsolete_id, source, dbuser):
