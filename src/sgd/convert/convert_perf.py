...
from src.sgd.convert.transformers import do_conversion, \
    ...
    make_orphan_backend_starter, OutputTransformer
...
if __name__ == "__main__":   
    ...
    do_conversion(make_backend_starter(nex_backend, 'all_bioitems', 100),
                  [Json2CorePerfDB(perf_session_maker, PerfBioitem, name='convert.from_backend.bioitem', commit_interval=100, delete_untouched=True)])
