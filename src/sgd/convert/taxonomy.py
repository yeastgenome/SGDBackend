            ...
            if len(pieces) == 2:
                if pieces[0] == 'synonym':
                    ...
                    if 'EXACT common_name' in quotation_split[2]:
                        ...
                        term['aliases'].append({'display_name': quotation_split[1], "alias_type": alias_type, "source": {"display_name": source}, 'created_by': dbuser})
                elif pieces[0] == 'is_a':
                    ...
                    parent_to_children[parent].append({'taxid': term['taxid'], 'display_name': term['display_name'], 'source': {'display_name': source}, 'rank': rank, 'ro_id': get_relation_to_ro_id('is a'), 'created_by': dbuser})
