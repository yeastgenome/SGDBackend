...
def locus_summary_starter(bud_session_maker):
...
if __name__ == '__main__':
    from src.sgd.convert import config
    basic_convert(config.BUD_HOST, config.NEX_HOST, locus_summary_starter, 'locus_summary', lambda x: (x['locus_id'], x['summary_type'], x['summary_order']))
