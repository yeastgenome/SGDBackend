...
def colleague_relation_starter(bud_session_maker):
...
if __name__ == '__main__':
    from src.sgd.convert import config
    basic_convert(config.BUD_HOST, config.NEX_HOST, colleague_relation_starter, 'colleague_relation', lambda x: (x['colleague_id'], x['associate_id'], x['association_type']))
