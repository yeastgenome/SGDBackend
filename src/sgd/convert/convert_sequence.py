...
from src.sgd.convert.transformers import do_conversion, Obj2NexDB, Json2Obj, make_file_starter, \
    Json2DataPerfDB, make_locus_data_backend_starter, make_contig_data_backend_starter, make_backend_starter, Json2CorePerfDB
...
if __name__ == "__main__":
    ...
    for sequence_filename, strain_key in protein_sequence_files[0:25]:
        print strain_key
