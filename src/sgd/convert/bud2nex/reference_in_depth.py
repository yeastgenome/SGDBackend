...
def create_abstract(old_reference, reference_ids):
    from src.sgd.model.nex.reference import Abstract as NewAbstract
...
def convert_abstract(old_session_maker, new_session_maker, chunk_size):
    from src.sgd.model.nex.reference import Reference as NewReference, Abstract as NewAbstract
...
def convert_bibentry(new_session_maker, chunk_size):
    from src.sgd.model.nex.reference import Reference as NewReference, Bibentry as NewBibentry, \
    ...
    try:
        ...
        for ar in new_session.query(NewAuthorReference).all():
            ...
            if reference_id in id_to_authors:
                ...
                id_to_authors[reference_id] = {author_name}
        ...
        for refreftype in new_session.query(NewReferenceReftype).all():
            ...
            if reference_id in id_to_reftypes:
                ...
                id_to_reftypes[reference_id] = {reftype_name}
...
def create_author(old_author, key_to_source):
    from src.sgd.model.nex.reference import Author as NewAuthor
...
def convert_author(old_session_maker, new_session_maker, chunk_size):
    from src.sgd.model.nex.reference import Author as NewAuthor
    from src.sgd.model.nex.evelements import Source as NewSource
    from src.sgd.model.bud.reference import Author as OldAuthor
...
def create_author_reference(old_author_reference, old_id_to_author, id_to_reference, key_to_source):
    from src.sgd.model.nex.reference import AuthorReference as NewAuthorReference
...
def convert_author_reference(old_session_maker, new_session_maker, chunk_size):
    from src.sgd.model.nex.reference import Author as NewAuthor, Reference as NewReference, AuthorReference as NewAuthorReference
    from src.sgd.model.nex.evelements import Source as NewSource
    from src.sgd.model.bud.reference import AuthorReference as OldAuthorReference, Author as OldAuthor
...
def create_reftype(old_reftype, key_to_source):
    from src.sgd.model.nex.reference import Reftype as NewReftype
...
def convert_reftype(old_session_maker, new_session_maker):
    from src.sgd.model.nex.reference import Reftype as NewReftype
    from src.sgd.model.nex.evelements import Source as NewSource
    from src.sgd.model.bud.reference import RefType as OldReftype
...
def create_reference_reftype(old_refreftype, id_to_source, id_to_reference, id_to_reftype):
    from src.sgd.model.nex.reference import ReferenceReftype as NewReferenceReftype
...
def convert_reference_reftype(old_session_maker, new_session_maker):
    from src.sgd.model.nex.reference import ReferenceReftype as NewReferenceReftype, Reference as NewReference, Reftype as NewReftype
    from src.sgd.model.nex.evelements import Source as NewSource
    from src.sgd.model.bud.reference import RefReftype as OldRefReftype
...
def create_reference_relation(old_ref_relation, id_to_reference, key_to_source):
    from src.sgd.model.nex.reference import Referencerelation as NewReferencerelation
...
def convert_reference_relation(old_session_maker, new_session_maker):
    from src.sgd.model.nex.reference import Referencerelation as NewReferencerelation, Reference as NewReference
    from src.sgd.model.nex.evelements import Source as NewSource
    from src.sgd.model.bud.reference import RefRelation as OldRefRelation
...
def create_alias(old_reference, id_to_reference, key_to_source):
    from src.sgd.model.nex.reference import Referencealias as NewReferencealias
...
def convert_alias(old_session_maker, new_session_maker, chunk_size):
    from src.sgd.model.nex.reference import Reference as NewReference, Referencealias as NewReferencealias
    from src.sgd.model.nex.evelements import Source as NewSource
    from src.sgd.model.bud.reference import Reference as OldReference
...
def create_url(reference, key_to_source):
    from src.sgd.model.nex.reference import Referenceurl as NewReferenceurl
...
def convert_url(new_session_maker, chunk_size):
    from src.sgd.model.nex.reference import Reference, Referenceurl as NewReferenceurl
    from src.sgd.model.nex.evelements import Source as NewSource
...
def convert(old_session_maker, new_session_maker):
    ...
    from src.sgd.model.nex.reference import Reference, Author
    convert_disambigs(new_session_maker, Reference, ['id', 'sgdid', 'pubmed_id', 'doi'], 'REFERENCE', None, 'convert.reference.disambigs', 3000)
