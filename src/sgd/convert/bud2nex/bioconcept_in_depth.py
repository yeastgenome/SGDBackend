...
def create_ecnumber_relation(ecnumber, key_to_ecnumber, key_to_source):
    from src.sgd.model.nex.bioconcept import Bioconceptrelation as NewBioconceptrelation
...
def create_chemical_phenotype_relation(old_phenotype, key_to_phenotype, key_to_source):
    from src.sgd.model.nex.bioconcept import Bioconceptrelation as NewBioconceptrelation, create_phenotype_format_name
...
def create_go_alias(old_goterm, key_to_go, key_to_source):
    from src.sgd.model.nex.bioconcept import Bioconceptalias as NewBioconceptalias
