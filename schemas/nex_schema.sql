...
CONSTRAINT RELATION_UK UNIQUE (FORMAT_NAME, CLASS) ) TABLESPACE DATA1;
...
CONSTRAINT CONDITION_UK UNIQUE (EVIDENCE_ID, FORMAT_NAME, SUBCLASS) ) TABLESPACE DATA1;
ALTER TABLE CONDITION 
ADD CONSTRAINT COND_EVID_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES EVIDENCE (EVIDENCE_ID) 
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX CHEMCOND_CHEM_FK ON CHEMICALCONDITION (CHEMICAL_ID) TABLESPACE DATA1; 
...
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
CREATE INDEX PAR_SOURCE_FK_INDEX ON PARAGRAPH (SOURCE_ID) TABLESPACE DATA1;
ALTER TABLE PARAGRAPH
ADD CONSTRAINT PAR_SOURCE_FK FOREIGN KEY (SOURCE_ID) REFERENCES SOURCE (SOURCE_ID) 
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
