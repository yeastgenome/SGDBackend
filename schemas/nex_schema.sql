...
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('LOCUS', 'PROTEIN')),
...
ALIAS_ID INTEGER NOT NULL,
BIOCONCEPT_ID INTEGER NOT NULL,
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('GO', 'PHENOTYPE', 'EC_NUMBER', 'COMPLEX')),
...
DROP TABLE COMPLEXBIOCONCEPT CASCADE CONSTRAINTS;
CREATE TABLE COMPLEXBIOCONCEPT (
BIOCONCEPT_ID INTEGER NOT NULL,
GO_ID INTEGER,
CELLULAR_LOCALIZATION VARCHAR2(100),
CONSTRAINT COMPLEXBIOCONCEPT_PK PRIMARY KEY (BIOCONCEPT_ID) ) TABLESPACE DATA1;
CREATE INDEX COMPLEXBIOCONCEPT_GO_INDEX ON COMPLEXBIOCONCEPT (GO_ID) TABLESPACE DATA1;
ALTER TABLE COMPLEXBIOCONCEPT
ADD CONSTRAINT COMPLEXBIOCON_BIOCON_FK FOREIGN KEY (BIOCONCEPT_ID) REFERENCES BIOCONCEPT (BIOCONCEPT_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE COMPLEXBIOCONCEPT
ADD CONSTRAINT COMPLEXBIOCON_GO_FK FOREIGN KEY (GO_ID) REFERENCES GOBIOCONCEPT (BIOCONCEPT_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
GRANT SELECT ON COMPLEXBIOCONCEPT TO DBSELECT;
GRANT DELETE, INSERT, SELECT, UPDATE ON COMPLEXBIOCONCEPT TO CURATOR;
GRANT DELETE, INSERT, SELECT, UPDATE ON COMPLEXBIOCONCEPT TO AUXILIARY;
...
STRAIN_ID INTEGER, 
SUBCLASS VARCHAR2(40) NOT NULL CHECK (SUBCLASS IN ('PHENOTYPE', 'GO', 'EC_NUMBER', 'GENINTERACTION', 'PHYSINTERACTION', 'BINDING', 'DOMAIN', 'QUALIFIER', 'LITERATURE', 'REGULATION')), 
NOTE VARCHAR2(1000), 
DATE_CREATED DATE DEFAULT SYSDATE NOT NULL, 
CREATED_BY VARCHAR2(12) DEFAULT SUBSTR(USER,1,12) NOT NULL, 
...
BIOENTITY_ID INTEGER NOT NULL, 
BIOCONCEPT_ID INTEGER NOT NULL, 
BIOENTITY_SUBCLASS VARCHAR2(40) NOT NULL CHECK (BIOENTITY_SUBCLASS IN ('LOCUS', 'PROTEIN')),
