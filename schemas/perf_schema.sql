...
ALTER TABLE BIOENTITY_OVERVIEW
ADD CONSTRAINT BIOENTITY_OVERVIEW_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES BIOENTITY (BIOENTITY_ID)
...
ALTER TABLE BIOENTITY_GRAPH
ADD CONSTRAINT BIOENTITY_GRAPH_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES BIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ALTER TABLE BIOENTITY_RESOURCES
ADD CONSTRAINT BIOENTITY_RESOURCES_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES BIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ALTER TABLE BIOENTITY_ENRICHMENT
ADD CONSTRAINT BIOENTITY_ENRICHMENT_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES BIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ALTER TABLE BIOENTITY_PARAGRAPH
ADD CONSTRAINT BIOENTITY_PARAGRAPH_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES BIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
ALTER TABLE BIOCONCEPT_GRAPH
ADD CONSTRAINT BIOCONCEPT_GRAPH_FK FOREIGN KEY (BIOCONCEPT_ID) REFERENCES BIOCONCEPT (BIOCONCEPT_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX BIOENTITY_EVIDENCE_FK1_INDX ON BIOENTITY_EVIDENCE (BIOENTITY_ID) TABLESPACE PDATA2;
CREATE INDEX BIOENTITY_EVIDENCE_FK2_INDX ON BIOENTITY_EVIDENCE (EVIDENCE_ID) TABLESPACE PDATA2;
ALTER TABLE BIOENTITY_EVIDENCE
ADD CONSTRAINT BIOENTITY_EVIDENCE_BIOENT_FK FOREIGN KEY (BIOENTITY_ID) REFERENCES BIOENTITY (BIOENTITY_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE BIOENTITY_EVIDENCE
ADD CONSTRAINT BIOENTITY_EVIDENCE_EV_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES EVIDENCE (EVIDENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX BIOCONCEPT_EVIDENCE_FK1_INDX ON BIOCONCEPT_EVIDENCE (BIOCONCEPT_ID) TABLESPACE PDATA2;
CREATE INDEX BIOCONCEPT_EVIDENCE_FK2_INDX ON BIOCONCEPT_EVIDENCE (EVIDENCE_ID) TABLESPACE PDATA2;
ALTER TABLE BIOCONCEPT_EVIDENCE
ADD CONSTRAINT BIOCONCEPT_EVIDENCE_BIOCON_FK FOREIGN KEY (BIOCONCEPT_ID) REFERENCES BIOCONCEPT (BIOCONCEPT_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE BIOCONCEPT_EVIDENCE
ADD CONSTRAINT BIOCONCEPT_EVIDENCE_EV_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES EVIDENCE (EVIDENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX REFERENCE_EVIDENCE_FK1_INDX ON REFERENCE_EVIDENCE (REFERENCE_ID) TABLESPACE PDATA2;
CREATE INDEX REFERENCE_EVIDENCE_FK2_INDX ON REFERENCE_EVIDENCE (EVIDENCE_ID) TABLESPACE PDATA2;
ALTER TABLE REFERENCE_EVIDENCE
ADD CONSTRAINT REFERENCE_EVIDENCE_REF_FK FOREIGN KEY (REFERENCE_ID) REFERENCES REFERENCE (REFERENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE REFERENCE_EVIDENCE
ADD CONSTRAINT REFERENCE_EVIDENCE_EV_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES EVIDENCE (EVIDENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
...
CREATE INDEX CHEMICAL_EVIDENCE_FK1_INDX ON CHEMICAL_EVIDENCE (CHEMICAL_ID) TABLESPACE PDATA2;
CREATE INDEX CHEMICAL_EVIDENCE_FK2_INDX ON CHEMICAL_EVIDENCE (EVIDENCE_ID) TABLESPACE PDATA2;
ALTER TABLE CHEMICAL_EVIDENCE
ADD CONSTRAINT CHEMICAL_EVIDENCE_CHEM_FK FOREIGN KEY (CHEMICAL_ID) REFERENCES CHEMICAL (CHEMICAL_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
ALTER TABLE CHEMICAL_EVIDENCE
ADD CONSTRAINT CHEMICAL_EVIDENCE_EV_FK FOREIGN KEY (EVIDENCE_ID) REFERENCES EVIDENCE (EVIDENCE_ID)
ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE;
