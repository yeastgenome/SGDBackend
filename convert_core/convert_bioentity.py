...
def create_transcript(old_protein, id_to_bioentity, key_to_source):
    from model_new_schema.bioentity import Transcript
...
def convert_transcript(old_session_maker, new_session_maker):
    from model_new_schema.bioentity import Bioentity as NewBioentity, Transcript as NewTranscript
    from model_new_schema.evelements import Source as NewSource
...
def convert_complex(new_session_maker):
    ...
    from model_new_schema.bioentity import Complex as NewComplex
    from model_new_schema.evelements import Source as NewSource
