...
def create_allele(old_phenotype_feature, key_to_source):
    ...
    if old_phenotype_feature.experiment is not None:
        ...
        if allele_info is not None:
            ...
            new_allele = NewAllele(allele_info[0], source, None)
            return [new_allele]
    return []
...
def convert_allele(old_session_maker, new_session_maker):
    ...
    try:
        ...
        for old_obj in old_objs:
            ...
            newly_created_objs = create_allele(old_obj, key_to_source)
